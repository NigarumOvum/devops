...
class TokenAdministrationClient(Client):
    ...
    def list_personal_access_tokens(self, audience, subject_descriptor, page_size=None, continuation_token=None, is_public=None):
        ...
        :param [str] audience:
        :param :class:`<str> <azure.devops.v6_0.token_administration.models.str>` subject_descriptor: The descriptor of the target user.
        ...
        :param bool is_public: Set to false for PAT tokens and true for SSH tokens.
        :rtype: :class:`<TokenAdminPagedSessionTokens> <azure.devops.v6_0.token_administration.models.TokenAdminPagedSessionTokens>`
        """
        route_values = {}
    ...
    def revoke_authorizations(self, revocations, host_id, is_public=None):
        ...
        [Preview API] Revokes the listed OAuth authorizations.
        :param :class:`<TokenAdministrationRevocation> <azure.devops.v6_0.token_administration.models.TokenAdministrationRevocation>` revocations: The list of objects containing the authorization IDs of the OAuth authorizations, such as session tokens retrieved by listed a users PATs, that should be revoked.
