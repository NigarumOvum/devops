...
class BacklogColumn(Model):
    ...
    :type column_field_reference: :class:`WorkItemFieldReference <azure.devops.v6_0.work.models.WorkItemFieldReference>`
    :param width:
    :type width: int
    """
...
class BacklogConfiguration(Model):
    ...
    :type backlog_fields: :class:`BacklogFields <azure.devops.v6_0.work.models.BacklogFields>`
    ...
    :type portfolio_backlogs: list of :class:`BacklogLevelConfiguration <azure.devops.v6_0.work.models.BacklogLevelConfiguration>`
    :param requirement_backlog: Requirement backlog
    :type requirement_backlog: :class:`BacklogLevelConfiguration <azure.devops.v6_0.work.models.BacklogLevelConfiguration>`
    :param task_backlog: Task backlog
    :type task_backlog: :class:`BacklogLevelConfiguration <azure.devops.v6_0.work.models.BacklogLevelConfiguration>`
    :param url:
    :type url: str
    :param work_item_type_mapped_states: Mapped states for work item types
    :type work_item_type_mapped_states: list of :class:`WorkItemTypeStateInfo <azure.devops.v6_0.work.models.WorkItemTypeStateInfo>`
    """
...
class BacklogLevelConfiguration(Model):
    ...
    :type add_panel_fields: list of :class:`WorkItemFieldReference <azure.devops.v6_0.work.models.WorkItemFieldReference>`
    :param color: Color for the backlog level
    :type color: str
    :param column_fields: Default list of columns for the backlog
    :type column_fields: list of :class:`BacklogColumn <azure.devops.v6_0.work.models.BacklogColumn>`
    :param default_work_item_type: Default Work Item Type for the backlog
    :type default_work_item_type: :class:`WorkItemTypeReference <azure.devops.v6_0.work.models.WorkItemTypeReference>`
    ...
    :type work_item_types: list of :class:`WorkItemTypeReference <azure.devops.v6_0.work.models.WorkItemTypeReference>`
    """
...
class BacklogLevelWorkItems(Model):
    ...
    :type work_items: list of :class:`WorkItemLink <azure.devops.v6_0.work.models.WorkItemLink>`
    """
...
class BoardCardRuleSettings(Model):
    """
    :param _links:
    :type _links: :class:`ReferenceLinks <azure.devops.v6_0.work.models.ReferenceLinks>`
    :param rules:
    :type rules: dict
    :param url:
    :type url: str
...
class BoardFields(Model):
    """
    :param column_field:
    :type column_field: :class:`FieldReference <azure.devops.v6_0.work.models.FieldReference>`
    :param done_field:
    :type done_field: :class:`FieldReference <azure.devops.v6_0.work.models.FieldReference>`
    :param row_field:
    :type row_field: :class:`FieldReference <azure.devops.v6_0.work.models.FieldReference>`
    """
...
class CapacityPatch(Model):
    ...
    :param activities:
    :type activities: list of :class:`Activity <azure.devops.v6_0.work.models.Activity>`
    :param days_off:
    :type days_off: list of :class:`DateRange <azure.devops.v6_0.work.models.DateRange>`
    """
...
class Plan(Model):
    ...
    :type created_by_identity: :class:`IdentityRef <azure.devops.v6_0.work.models.IdentityRef>`
    ...
    :type modified_by_identity: :class:`IdentityRef <azure.devops.v6_0.work.models.IdentityRef>`
...
class PredefinedQuery(Model):
    ...
    :type results: list of :class:`WorkItem <azure.devops.v6_0.work.models.WorkItem>`
...
class ProcessConfiguration(Model):
    ...
    :type bug_work_items: :class:`CategoryConfiguration <azure.devops.v6_0.work.models.CategoryConfiguration>`
    :param portfolio_backlogs: Details about portfolio backlogs
    :type portfolio_backlogs: list of :class:`CategoryConfiguration <azure.devops.v6_0.work.models.CategoryConfiguration>`
    :param requirement_backlog: Details of requirement backlog
    :type requirement_backlog: :class:`CategoryConfiguration <azure.devops.v6_0.work.models.CategoryConfiguration>`
    :param task_backlog: Details of task backlog
    :type task_backlog: :class:`CategoryConfiguration <azure.devops.v6_0.work.models.CategoryConfiguration>`
...
class Rule(Model):
    """
    :param clauses:
    :type clauses: list of :class:`FilterClause <azure.devops.v6_0.work.models.FilterClause>`
    :param filter:
    :type filter: str
    :param is_enabled:
    :type is_enabled: str
...
class TaskboardColumn(Model):
    ...
    :type mappings: list of :class:`ITaskboardColumnMapping <azure.devops.v6_0.work.models.ITaskboardColumnMapping>`
...
class TaskboardColumns(Model):
    """
    :param columns:
    :type columns: list of :class:`TaskboardColumn <azure.devops.v6_0.work.models.TaskboardColumn>`
...
class TeamFieldValuesPatch(Model):
    ...
    :param values:
    :type values: list of :class:`TeamFieldValue <azure.devops.v6_0.work.models.TeamFieldValue>`
    """
...
class TeamSettingsIteration(TeamSettingsDataContractBase):
    ...
    :type attributes: :class:`TeamIterationAttributes <azure.devops.v6_0.work.models.TeamIterationAttributes>`
...
class TimelineTeamData(Model):
    ...
    :type backlog: :class:`BacklogLevel <azure.devops.v6_0.work.models.BacklogLevel>`
    ...
    :type iterations: list of :class:`TimelineTeamIteration <azure.devops.v6_0.work.models.TimelineTeamIteration>`
    ...
    :type status: :class:`TimelineTeamStatus <azure.devops.v6_0.work.models.TimelineTeamStatus>`
    ...
    :type team_field_values: list of :class:`TeamFieldValue <azure.devops.v6_0.work.models.TeamFieldValue>`
    :param work_item_type_colors: Colors for the work item types.
    :type work_item_type_colors: list of :class:`WorkItemColor <azure.devops.v6_0.work.models.WorkItemColor>`
    """
...
class TimelineTeamIteration(Model):
    ...
    :type status: :class:`TimelineIterationStatus <azure.devops.v6_0.work.models.TimelineIterationStatus>`
...
class UpdateTaskboardColumn(Model):
    ...
    :type id: str
    :param mappings: Work item type states mapped to this column to support auto state update when column is updated.
    :type mappings: list of :class:`TaskboardColumnMapping <azure.devops.v6_0.work.models.TaskboardColumnMapping>`
...
class WorkItemLink(Model):
    ...
    :type source: :class:`WorkItemReference <azure.devops.v6_0.microsoft._team_foundation._work_item_tracking._web_api.models.WorkItemReference>`
    :param target: The target work item.
    :type target: :class:`WorkItemReference <azure.devops.v6_0.microsoft._team_foundation._work_item_tracking._web_api.models.WorkItemReference>`
    """
...
class Board(BoardReference):
    ...
    :type can_edit: bool
    :param columns:
    :type columns: list of :class:`BoardColumn <azure.devops.v6_0.work.models.BoardColumn>`
    :param fields:
    :type fields: :class:`BoardFields <azure.devops.v6_0.work.models.BoardFields>`
    :param is_valid:
    :type is_valid: bool
    :param revision:
    :type revision: int
    :param rows:
    :type rows: list of :class:`BoardRow <azure.devops.v6_0.work.models.BoardRow>`
    """
...
class DeliveryViewData(PlanViewData):
    ...
    :type criteria_status: :class:`TimelineCriteriaStatus <azure.devops.v6_0.work.models.TimelineCriteriaStatus>`
    ...
    :type teams: list of :class:`TimelineTeamData <azure.devops.v6_0.work.models.TimelineTeamData>`
    """
...
class IterationWorkItems(TeamSettingsDataContractBase):
    ...
    :type work_item_relations: list of :class:`WorkItemLink <azure.devops.v6_0.work.models.WorkItemLink>`
    """
...
class TeamFieldValues(TeamSettingsDataContractBase):
    ...
    :type field: :class:`FieldReference <azure.devops.v6_0.work.models.FieldReference>`
...
class TeamMemberCapacity(CapacityContractBase):
    ...
    :type team_member: :class:`Member <azure.devops.v6_0.work.models.Member>`
    """
...
class TeamMemberCapacityIdentityRef(CapacityContractBase):
    ...
    :type team_member: :class:`IdentityRef <azure.devops.v6_0.work.models.IdentityRef>`
    """
...
class TeamSetting(TeamSettingsDataContractBase):
    ...
    :type backlog_iteration: :class:`TeamSettingsIteration <azure.devops.v6_0.work.models.TeamSettingsIteration>`
    ...
    :type default_iteration: :class:`TeamSettingsIteration <azure.devops.v6_0.work.models.TeamSettingsIteration>`
...
class WorkItemTrackingResource(WorkItemTrackingResourceReference):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v6_0.microsoft._team_foundation._work_item_tracking._web_api.models.ReferenceLinks>`
    """
...
class WorkItem(WorkItemTrackingResource):
    ...
    :type comment_version_ref: :class:`WorkItemCommentVersionRef <azure.devops.v6_0.microsoft._team_foundation._work_item_tracking._web_api.models.WorkItemCommentVersionRef>`
    :param fields: Map of field and values for the work item.
    :type fields: dict
    :param id: The work item ID.
    :type id: int
    :param relations: Relations of the work item.
    :type relations: list of :class:`WorkItemRelation <azure.devops.v6_0.microsoft._team_foundation._work_item_tracking._web_api.models.WorkItemRelation>`
