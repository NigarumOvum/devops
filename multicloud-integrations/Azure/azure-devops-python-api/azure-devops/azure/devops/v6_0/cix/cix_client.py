...
class CixClient(Client):
    ...
    def create_project_connection(self, create_connection_inputs, project):
        ...
        :param :class:`<CreatePipelineConnectionInputs> <azure.devops.v6_0.cix.models.CreatePipelineConnectionInputs>` create_connection_inputs:
        :param str project:
        :rtype: :class:`<PipelineConnection> <azure.devops.v6_0.cix.models.PipelineConnection>`
        """
        query_parameters = {}
        if project is not None:
    ...
    def create_resources(self, creation_parameters, project):
        ...
        :param str project: Project ID or project name
        :rtype: :class:`<CreatedResources> <azure.devops.v6_0.cix.models.CreatedResources>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def render_template(self, template_parameters, template_id):
        """RenderTemplate.
        [Preview API]
        :param :class:`<TemplateParameters> <azure.devops.v6_0.cix.models.TemplateParameters>` template_parameters:
        :param str template_id:
        :rtype: :class:`<Template> <azure.devops.v6_0.cix.models.Template>`
        """
        route_values = {}
