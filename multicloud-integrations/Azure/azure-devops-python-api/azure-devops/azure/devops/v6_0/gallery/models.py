...
class AcquisitionOptions(Model):
    ...
    :type default_operation: :class:`AcquisitionOperation <azure.devops.v6_0.gallery.models.AcquisitionOperation>`
    :param item_id: The item id that this options refer to
    :type item_id: str
    :param operations: Operations allowed for the ItemId in this target
    :type operations: list of :class:`AcquisitionOperation <azure.devops.v6_0.gallery.models.AcquisitionOperation>`
...
class AssetDetails(Model):
    ...
    :type answers: :class:`Answers <azure.devops.v6_0.gallery.models.Answers>`
...
class AzureRestApiRequestModel(Model):
    ...
    :type asset_details: :class:`AssetDetails <azure.devops.v6_0.gallery.models.AssetDetails>`
...
class CategoriesResult(Model):
    ...
    :param categories:
    :type categories: list of :class:`ExtensionCategory <azure.devops.v6_0.gallery.models.ExtensionCategory>`
    """
...
class ExtensionAcquisitionRequest(Model):
    ...
    :type properties: :class:`object <azure.devops.v6_0.gallery.models.object>`
...
class ExtensionCategory(Model):
    ...
    :type language_titles: list of :class:`CategoryLanguageTitle <azure.devops.v6_0.gallery.models.CategoryLanguageTitle>`
...
class ExtensionDailyStat(Model):
    ...
    :type counts: :class:`EventCounts <azure.devops.v6_0.gallery.models.EventCounts>`
...
class ExtensionDailyStats(Model):
    ...
    :type daily_stats: list of :class:`ExtensionDailyStat <azure.devops.v6_0.gallery.models.ExtensionDailyStat>`
...
class ExtensionDraft(Model):
    """
    :param assets:
    :type assets: list of :class:`ExtensionDraftAsset <azure.devops.v6_0.gallery.models.ExtensionDraftAsset>`
    :param created_date:
    ...
    :param payload:
    :type payload: :class:`ExtensionPayload <azure.devops.v6_0.gallery.models.ExtensionPayload>`
    :param product:
    :type product: str
    :param publisher_name:
    :type publisher_name: str
...
class ExtensionDraftPatch(Model):
    ...
    :type extension_data: :class:`UnpackagedExtensionData <azure.devops.v6_0.gallery.models.UnpackagedExtensionData>`
    :param operation:
...
class ExtensionFilterResult(Model):
    ...
    :type extensions: list of :class:`PublishedExtension <azure.devops.v6_0.gallery.models.PublishedExtension>`
    ...
    :type result_metadata: list of :class:`ExtensionFilterResultMetadata <azure.devops.v6_0.gallery.models.ExtensionFilterResultMetadata>`
    """
...
class ExtensionFilterResultMetadata(Model):
    ...
    :type metadata_items: list of :class:`MetadataItem <azure.devops.v6_0.gallery.models.MetadataItem>`
...
class ExtensionPayload(Model):
    ...
    :type installation_targets: list of :class:`InstallationTarget <azure.devops.v6_0.gallery.models.InstallationTarget>`
    :param is_preview:
...
class ExtensionQuery(Model):
    ...
    :type filters: list of :class:`QueryFilter <azure.devops.v6_0.gallery.models.QueryFilter>`
...
class ExtensionQueryResult(Model):
    ...
    :type results: list of :class:`ExtensionFilterResult <azure.devops.v6_0.gallery.models.ExtensionFilterResult>`
    """
...
class ExtensionStatisticUpdate(Model):
    ...
    :type publisher_name: str
    :param statistic:
    :type statistic: :class:`ExtensionStatistic <azure.devops.v6_0.gallery.models.ExtensionStatistic>`
    """
...
class ExtensionVersion(Model):
    ...
    :type asset_uri: str
    :param badges:
    :type badges: list of :class:`ExtensionBadge <azure.devops.v6_0.gallery.models.ExtensionBadge>`
    :param fallback_asset_uri:
    :type fallback_asset_uri: str
    :param files:
    :type files: list of :class:`ExtensionFile <azure.devops.v6_0.gallery.models.ExtensionFile>`
    :param flags:
    :type flags: object
    :param last_updated:
    :type last_updated: datetime
...
class ProductCategoriesResult(Model):
    ...
    :param categories:
    :type categories: list of :class:`ProductCategory <azure.devops.v6_0.gallery.models.ProductCategory>`
    """
...
class ProductCategory(Model):
    ...
    :param children:
    :type children: list of :class:`ProductCategory <azure.devops.v6_0.gallery.models.ProductCategory>`
...
class PublishedExtension(Model):
    ...
    :param publisher:
    :type publisher: :class:`PublisherFacts <azure.devops.v6_0.gallery.models.PublisherFacts>`
    :param release_date: Date on which the extension first went public.
    :type release_date: datetime
    :param shared_with:
    :type shared_with: list of :class:`ExtensionShare <azure.devops.v6_0.gallery.models.ExtensionShare>`
    :param short_description:
    :type short_description: str
    :param statistics:
    :type statistics: list of :class:`ExtensionStatistic <azure.devops.v6_0.gallery.models.ExtensionStatistic>`
    :param tags:
    :type tags: list of str
    :param versions:
    :type versions: list of :class:`ExtensionVersion <azure.devops.v6_0.gallery.models.ExtensionVersion>`
    """
...
class PublisherFilterResult(Model):
    ...
    :type publishers: list of :class:`Publisher <azure.devops.v6_0.gallery.models.Publisher>`
    """
...
class PublisherQueryResult(Model):
    ...
    :param results: For each filter supplied in the query, a filter result will be returned in the query result.
    :type results: list of :class:`PublisherFilterResult <azure.devops.v6_0.gallery.models.PublisherFilterResult>`
    """
...
class PublisherRoleAssignment(Model):
    ...
    :type identity: :class:`IdentityRef <azure.devops.v6_0.gallery.models.IdentityRef>`
    :param role: The role assigned to the user.
    :type role: :class:`PublisherSecurityRole <azure.devops.v6_0.gallery.models.PublisherSecurityRole>`
    """
...
class QnAItem(Model):
    ...
    :type user: :class:`UserIdentityRef <azure.devops.v6_0.gallery.models.UserIdentityRef>`
    """
...
class QueryFilter(Model):
    ...
    :type criteria: list of :class:`FilterCriteria <azure.devops.v6_0.gallery.models.FilterCriteria>`
...
class Question(QnAItem):
    ...
    :type responses: list of :class:`Response <azure.devops.v6_0.gallery.models.Response>`
    """
...
class QuestionsResult(Model):
    ...
    :type questions: list of :class:`Question <azure.devops.v6_0.gallery.models.Question>`
    """
...
class Review(Model):
    ...
    :type admin_reply: :class:`ReviewReply <azure.devops.v6_0.gallery.models.ReviewReply>`
    ...
    :type reply: :class:`ReviewReply <azure.devops.v6_0.gallery.models.ReviewReply>`
...
class ReviewPatch(Model):
    ...
    :type reported_concern: :class:`UserReportedConcern <azure.devops.v6_0.gallery.models.UserReportedConcern>`
    :param review_item: Use when patch operation is EditReview
    :type review_item: :class:`Review <azure.devops.v6_0.gallery.models.Review>`
    """
...
class ReviewsResult(Model):
    ...
    :type reviews: list of :class:`Review <azure.devops.v6_0.gallery.models.Review>`
...
class Publisher(PublisherBase):
    ...
    :type state: object
    :param _links:
    :type _links: :class:`ReferenceLinks <azure.devops.v6_0.gallery.models.ReferenceLinks>`
    """
