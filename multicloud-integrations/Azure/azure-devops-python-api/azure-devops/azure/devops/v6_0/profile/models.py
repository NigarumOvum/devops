...
class Profile(Model):
    ...
    :type application_container: :class:`AttributesContainer <azure.devops.v6_0.profile.models.AttributesContainer>`
...
class ProfileAttributeBase(Model):
    ...
    :type descriptor: :class:`AttributeDescriptor <azure.devops.v6_0.profile.models.AttributeDescriptor>`
