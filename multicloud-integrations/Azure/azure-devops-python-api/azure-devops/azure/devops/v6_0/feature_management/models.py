...
class ContributedFeature(Model):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v6_0.feature_management.models.ReferenceLinks>`
    ...
    :type default_value_rules: list of :class:`ContributedFeatureValueRule <azure.devops.v6_0.feature_management.models.ContributedFeatureValueRule>`
    ...
    :type feature_state_changed_listeners: list of :class:`ContributedFeatureListener <azure.devops.v6_0.feature_management.models.ContributedFeatureListener>`
    ...
    :type override_rules: list of :class:`ContributedFeatureValueRule <azure.devops.v6_0.feature_management.models.ContributedFeatureValueRule>`
    :param scopes: The scopes/levels at which settings can set the enabled/disabled state of this feature
    :type scopes: list of :class:`ContributedFeatureSettingScope <azure.devops.v6_0.feature_management.models.ContributedFeatureSettingScope>`
...
class ContributedFeatureState(Model):
    ...
    :type scope: :class:`ContributedFeatureSettingScope <azure.devops.v6_0.feature_management.models.ContributedFeatureSettingScope>`
