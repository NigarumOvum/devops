...
class FeatureManagementClient(Client):
    ...
    def get_feature(self, feature_id):
        ...
        :rtype: :class:`<ContributedFeature> <azure.devops.v6_0.feature_management.models.ContributedFeature>`
        """
        route_values = {}
    ...
    def get_feature_state(self, feature_id, user_scope):
        ...
        :rtype: :class:`<ContributedFeatureState> <azure.devops.v6_0.feature_management.models.ContributedFeatureState>`
        """
        route_values = {}
        if feature_id is not None:
            route_values['featureId'] = self._serialize.url('feature_id', feature_id, 'str')
    ...
    def set_feature_state(self, feature, feature_id, user_scope, reason=None, reason_code=None):
        ...
        :param :class:`<ContributedFeatureState> <azure.devops.v6_0.feature_management.models.ContributedFeatureState>` feature: Posted feature state object. Should specify the effective value.
        :param str feature_id: Contribution id of the feature
    ...
    def query_feature_states(self, query):
        ...
        :param :class:`<ContributedFeatureStateQuery> <azure.devops.v6_0.feature_management.models.ContributedFeatureStateQuery>` query: Features to query along with current scope values
        :rtype: :class:`<ContributedFeatureStateQuery> <azure.devops.v6_0.feature_management.models.ContributedFeatureStateQuery>`
        """
    ...
    def query_feature_states_for_default_scope(self, query, user_scope):
        ...
        :param :class:`<ContributedFeatureStateQuery> <azure.devops.v6_0.feature_management.models.ContributedFeatureStateQuery>` query: Query describing the features to query.
