...
class AccountMyWorkResult(Model):
    ...
    :type work_item_details: list of :class:`AccountWorkWorkItemModel <azure.devops.v6_0.work_item_tracking.models.AccountWorkWorkItemModel>`
    """
...
class ExternalDeployment(Model):
    ...
    :param environment:
    :type environment: :class:`ExternalEnvironment <azure.devops.v6_0.work_item_tracking.models.ExternalEnvironment>`
    :param group:
    :type group: str
    :param pipeline:
    :type pipeline: :class:`ExternalPipeline <azure.devops.v6_0.work_item_tracking.models.ExternalPipeline>`
...
class ProjectWorkItemStateColors(Model):
    ...
    :type work_item_type_state_colors: list of :class:`WorkItemTypeStateColors <azure.devops.v6_0.work_item_tracking.models.WorkItemTypeStateColors>`
    """
...
class QueryHierarchyItemsResult(Model):
    ...
    :type value: list of :class:`QueryHierarchyItem <azure.devops.v6_0.work_item_tracking.models.QueryHierarchyItem>`
    """
...
class WorkItemLink(Model):
    ...
    :type source: :class:`WorkItemReference <azure.devops.v6_0.work_item_tracking.models.WorkItemReference>`
    :param target: The target work item.
    :type target: :class:`WorkItemReference <azure.devops.v6_0.work_item_tracking.models.WorkItemReference>`
    """
...
class WorkItemQueryClause(Model):
    ...
    :type clauses: list of :class:`WorkItemQueryClause <azure.devops.v6_0.work_item_tracking.models.WorkItemQueryClause>`
    :param field: Field associated with condition
    :type field: :class:`WorkItemFieldReference <azure.devops.v6_0.work_item_tracking.models.WorkItemFieldReference>`
    :param field_value: Right side of the condition when a field to field comparison
    :type field_value: :class:`WorkItemFieldReference <azure.devops.v6_0.work_item_tracking.models.WorkItemFieldReference>`
    ...
    :type operator: :class:`WorkItemFieldOperation <azure.devops.v6_0.work_item_tracking.models.WorkItemFieldOperation>`
...
class WorkItemQueryResult(Model):
    ...
    :type columns: list of :class:`WorkItemFieldReference <azure.devops.v6_0.work_item_tracking.models.WorkItemFieldReference>`
    ...
    :type sort_columns: list of :class:`WorkItemQuerySortColumn <azure.devops.v6_0.work_item_tracking.models.WorkItemQuerySortColumn>`
    :param work_item_relations: The work item links returned by the query.
    :type work_item_relations: list of :class:`WorkItemLink <azure.devops.v6_0.work_item_tracking.models.WorkItemLink>`
    :param work_items: The work items returned by the query.
    :type work_items: list of :class:`WorkItemReference <azure.devops.v6_0.work_item_tracking.models.WorkItemReference>`
    """
...
class WorkItemRelationUpdates(Model):
    ...
    :type added: list of :class:`WorkItemRelation <azure.devops.v6_0.work_item_tracking.models.WorkItemRelation>`
    :param removed: List of removed relations.
    :type removed: list of :class:`WorkItemRelation <azure.devops.v6_0.work_item_tracking.models.WorkItemRelation>`
    :param updated: List of updated relations.
    :type updated: list of :class:`WorkItemRelation <azure.devops.v6_0.work_item_tracking.models.WorkItemRelation>`
    """
...
class WorkItemTypeFieldInstanceBase(WorkItemFieldReference):
    ...
    :type dependent_fields: list of :class:`WorkItemFieldReference <azure.devops.v6_0.work_item_tracking.models.WorkItemFieldReference>`
...
class WorkItemTypeStateColors(Model):
    ...
    :type state_colors: list of :class:`WorkItemStateColor <azure.devops.v6_0.work_item_tracking.models.WorkItemStateColor>`
...
class AccountRecentActivityWorkItemModel2(AccountRecentActivityWorkItemModelBase):
    ...
    :type work_item_type: str
    :param assigned_to: Assigned To
    :type assigned_to: :class:`IdentityRef <azure.devops.v6_0.work_item_tracking.models.IdentityRef>`
    """
...
class WorkItemDelete(WorkItemDeleteReference):
    ...
    :type resource: :class:`WorkItem <azure.devops.v6_0.work_item_tracking.models.WorkItem>`
    """
...
class WorkItemType(WorkItemTrackingResource):
    ...
    :type field_instances: list of :class:`WorkItemTypeFieldInstance <azure.devops.v6_0.work_item_tracking.models.WorkItemTypeFieldInstance>`
    :param fields: The fields that exist on the work item type.
    :type fields: list of :class:`WorkItemTypeFieldInstance <azure.devops.v6_0.work_item_tracking.models.WorkItemTypeFieldInstance>`
    :param icon: The icon of the work item type.
    :type icon: :class:`WorkItemIcon <azure.devops.v6_0.work_item_tracking.models.WorkItemIcon>`
    ...
    :type states: list of :class:`WorkItemStateColor <azure.devops.v6_0.work_item_tracking.models.WorkItemStateColor>`
...
class WorkItemTypeCategory(WorkItemTrackingResource):
    ...
    :type default_work_item_type: :class:`WorkItemTypeReference <azure.devops.v6_0.work_item_tracking.models.WorkItemTypeReference>`
    ...
    :type work_item_types: list of :class:`WorkItemTypeReference <azure.devops.v6_0.work_item_tracking.models.WorkItemTypeReference>`
    """
...
class WorkItemUpdate(WorkItemTrackingResource):
    ...
    :type relations: :class:`WorkItemRelationUpdates <azure.devops.v6_0.work_item_tracking.models.WorkItemRelationUpdates>`
    :param rev: The revision number of work item update.
    :type rev: int
    :param revised_by: Identity for the work item update.
    :type revised_by: :class:`IdentityReference <azure.devops.v6_0.work_item_tracking.models.IdentityReference>`
...
class Comment(WorkItemTrackingResource):
    ...
    :type created_by: :class:`IdentityRef <azure.devops.v6_0.work_item_tracking.models.IdentityRef>`
    ...
    :type created_on_behalf_of: :class:`IdentityRef <azure.devops.v6_0.work_item_tracking.models.IdentityRef>`
    ...
    :type mentions: list of :class:`CommentMention <azure.devops.v6_0.work_item_tracking.models.CommentMention>`
    :param modified_by: IdentityRef of the user who last modified the comment.
    :type modified_by: :class:`IdentityRef <azure.devops.v6_0.work_item_tracking.models.IdentityRef>`
    :param modified_date: The last modification date of the comment.
    :type modified_date: datetime
    :param reactions: The reactions of the comment.
    :type reactions: list of :class:`CommentReaction <azure.devops.v6_0.work_item_tracking.models.CommentReaction>`
    :param text: The text of the comment.
    :type text: str
...
class CommentList(WorkItemTrackingResource):
    ...
    :type comments: list of :class:`Comment <azure.devops.v6_0.work_item_tracking.models.Comment>`
...
class QueryHierarchyItem(WorkItemTrackingResource):
    ...
    :type children: list of :class:`QueryHierarchyItem <azure.devops.v6_0.work_item_tracking.models.QueryHierarchyItem>`
    :param clauses: The clauses for a flat query.
    :type clauses: :class:`WorkItemQueryClause <azure.devops.v6_0.work_item_tracking.models.WorkItemQueryClause>`
    :param columns: The columns of the query.
    :type columns: list of :class:`WorkItemFieldReference <azure.devops.v6_0.work_item_tracking.models.WorkItemFieldReference>`
    :param created_by: The identity who created the query item.
    :type created_by: :class:`IdentityReference <azure.devops.v6_0.work_item_tracking.models.IdentityReference>`
    ...
    :type last_executed_by: :class:`IdentityReference <azure.devops.v6_0.work_item_tracking.models.IdentityReference>`
    ...
    :type last_modified_by: :class:`IdentityReference <azure.devops.v6_0.work_item_tracking.models.IdentityReference>`
    :param last_modified_date: When the query item was last modified.
    :type last_modified_date: datetime
    :param link_clauses: The link query clause.
    :type link_clauses: :class:`WorkItemQueryClause <azure.devops.v6_0.work_item_tracking.models.WorkItemQueryClause>`
    ...
    :type source_clauses: :class:`WorkItemQueryClause <azure.devops.v6_0.work_item_tracking.models.WorkItemQueryClause>`
    :param target_clauses: The target clauses in a tree or one-hop link query.
    :type target_clauses: :class:`WorkItemQueryClause <azure.devops.v6_0.work_item_tracking.models.WorkItemQueryClause>`
...
class WorkItemClassificationNode(WorkItemTrackingResource):
    ...
    :type children: list of :class:`WorkItemClassificationNode <azure.devops.v6_0.work_item_tracking.models.WorkItemClassificationNode>`
...
class WorkItemComments(WorkItemTrackingResource):
    ...
    :type comments: list of :class:`WorkItemComment <azure.devops.v6_0.work_item_tracking.models.WorkItemComment>`
...
class WorkItemField(WorkItemTrackingResource):
    ...
    :type supported_operations: list of :class:`WorkItemFieldOperation <azure.devops.v6_0.work_item_tracking.models.WorkItemFieldOperation>`
