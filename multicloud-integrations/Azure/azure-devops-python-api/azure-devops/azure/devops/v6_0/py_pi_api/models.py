...
class Package(Model):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v6_0.py_pi.models.ReferenceLinks>`
    ...
    :type source_chain: list of :class:`UpstreamSourceInfo <azure.devops.v6_0.py_pi.models.UpstreamSourceInfo>`
...
class PackageVersionDetails(Model):
    ...
    :type views: :class:`JsonPatchOperation <azure.devops.v6_0.py_pi.models.JsonPatchOperation>`
    """
...
class PyPiPackagesBatchRequest(Model):
    ...
    :type data: :class:`BatchOperationData <azure.devops.v6_0.py_pi.models.BatchOperationData>`
    ...
    :type packages: list of :class:`MinimalPackageDetails <azure.devops.v6_0.py_pi.models.MinimalPackageDetails>`
    """
