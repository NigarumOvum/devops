...
class AcquisitionOperation(Model):
    ...
    :type reasons: list of :class:`AcquisitionOperationDisallowReason <azure.devops.v6_0.extension_management.models.AcquisitionOperationDisallowReason>`
    """
...
class AcquisitionOptions(Model):
    ...
    :type default_operation: :class:`AcquisitionOperation <azure.devops.v6_0.extension_management.models.AcquisitionOperation>`
    :param item_id: The item id that this options refer to
    :type item_id: str
    :param operations: Operations allowed for the ItemId in this target
    :type operations: list of :class:`AcquisitionOperation <azure.devops.v6_0.extension_management.models.AcquisitionOperation>`
    :param properties: Additional properties which can be added to the request.
    :type properties: :class:`object <azure.devops.v6_0.extension_management.models.object>`
...
class ExtensionAuditLog(Model):
    ...
    :type entries: list of :class:`ExtensionAuditLogEntry <azure.devops.v6_0.extension_management.models.ExtensionAuditLogEntry>`
...
class ExtensionAuditLogEntry(Model):
    ...
    :type updated_by: :class:`IdentityRef <azure.devops.v6_0.extension_management.models.IdentityRef>`
    """
...
class ExtensionDataCollection(Model):
    ...
    :type documents: list of :class:`object <azure.devops.v6_0.extension_management.models.object>`
...
class ExtensionDataCollectionQuery(Model):
    ...
    :type collections: list of :class:`ExtensionDataCollection <azure.devops.v6_0.extension_management.models.ExtensionDataCollection>`
    """
...
class ExtensionEventCallbackCollection(Model):
    ...
    :type post_disable: :class:`ExtensionEventCallback <azure.devops.v6_0.extension_management.models.ExtensionEventCallback>`
    ...
    :type post_enable: :class:`ExtensionEventCallback <azure.devops.v6_0.extension_management.models.ExtensionEventCallback>`
    ...
    :type post_install: :class:`ExtensionEventCallback <azure.devops.v6_0.extension_management.models.ExtensionEventCallback>`
    ...
    :type post_uninstall: :class:`ExtensionEventCallback <azure.devops.v6_0.extension_management.models.ExtensionEventCallback>`
    ...
    :type post_update: :class:`ExtensionEventCallback <azure.devops.v6_0.extension_management.models.ExtensionEventCallback>`
    ...
    :type pre_install: :class:`ExtensionEventCallback <azure.devops.v6_0.extension_management.models.ExtensionEventCallback>`
    ...
    :type version_check: :class:`ExtensionEventCallback <azure.devops.v6_0.extension_management.models.ExtensionEventCallback>`
    """
...
class ExtensionLicensing(Model):
    ...
    :type overrides: list of :class:`LicensingOverride <azure.devops.v6_0.extension_management.models.LicensingOverride>`
    """
...
class ExtensionManifest(Model):
    ...
    :type constraints: list of :class:`ContributionConstraint <azure.devops.v6_0.extension_management.models.ContributionConstraint>`
    :param contributions: List of contributions made by this extension
    :type contributions: list of :class:`Contribution <azure.devops.v6_0.extension_management.models.Contribution>`
    :param contribution_types: List of contribution types defined by this extension
    :type contribution_types: list of :class:`ContributionType <azure.devops.v6_0.extension_management.models.ContributionType>`
    ...
    :type event_callbacks: :class:`ExtensionEventCallbackCollection <azure.devops.v6_0.extension_management.models.ExtensionEventCallbackCollection>`
    ...
    :type licensing: :class:`ExtensionLicensing <azure.devops.v6_0.extension_management.models.ExtensionLicensing>`
...
class ExtensionRequest(Model):
    ...
    :type requested_by: :class:`IdentityRef <azure.devops.v6_0.extension_management.models.IdentityRef>`
    ...
    :type resolved_by: :class:`IdentityRef <azure.devops.v6_0.extension_management.models.IdentityRef>`
    """
...
class ExtensionVersion(Model):
    ...
    :type asset_uri: str
    :param badges:
    :type badges: list of :class:`ExtensionBadge <azure.devops.v6_0.microsoft._visual_studio._services._gallery._web_api.models.ExtensionBadge>`
    :param fallback_asset_uri:
    :type fallback_asset_uri: str
    :param files:
    :type files: list of :class:`ExtensionFile <azure.devops.v6_0.microsoft._visual_studio._services._gallery._web_api.models.ExtensionFile>`
    :param flags:
    :type flags: object
    :param last_updated:
...
class InstalledExtension(ExtensionManifest):
    ...
    :type files: list of :class:`ExtensionFile <azure.devops.v6_0.extension_management.models.ExtensionFile>`
    ...
    :type install_state: :class:`InstalledExtensionState <azure.devops.v6_0.extension_management.models.InstalledExtensionState>`
...
class InstalledExtensionQuery(Model):
    ...
    :param monikers:
    :type monikers: list of :class:`ExtensionIdentifier <azure.devops.v6_0.extension_management.models.ExtensionIdentifier>`
    """
...
class InstalledExtensionState(Model):
    ...
    :type installation_issues: list of :class:`InstalledExtensionStateIssue <azure.devops.v6_0.extension_management.models.InstalledExtensionStateIssue>`
...
class PublishedExtension(Model):
    ...
    :type installation_targets: list of :class:`InstallationTarget <azure.devops.v6_0.microsoft._visual_studio._services._gallery._web_api.models.InstallationTarget>`
    :param last_updated:
    :type last_updated: datetime
    ...
    :param publisher:
    :type publisher: :class:`PublisherFacts <azure.devops.v6_0.microsoft._visual_studio._services._gallery._web_api.models.PublisherFacts>`
    :param release_date: Date on which the extension first went public.
    :type release_date: datetime
    :param shared_with:
    :type shared_with: list of :class:`ExtensionShare <azure.devops.v6_0.microsoft._visual_studio._services._gallery._web_api.models.ExtensionShare>`
    :param short_description:
    :type short_description: str
    :param statistics:
    :type statistics: list of :class:`ExtensionStatistic <azure.devops.v6_0.microsoft._visual_studio._services._gallery._web_api.models.ExtensionStatistic>`
    :param tags:
    :type tags: list of str
    :param versions:
    :type versions: list of :class:`ExtensionVersion <azure.devops.v6_0.microsoft._visual_studio._services._gallery._web_api.models.ExtensionVersion>`
    """
...
class RequestedExtension(Model):
    ...
    :type extension_requests: list of :class:`ExtensionRequest <azure.devops.v6_0.extension_management.models.ExtensionRequest>`
...
class UserExtensionPolicy(Model):
    ...
    :type permissions: :class:`ExtensionPolicy <azure.devops.v6_0.microsoft._visual_studio._services._gallery._web_api.models.ExtensionPolicy>`
