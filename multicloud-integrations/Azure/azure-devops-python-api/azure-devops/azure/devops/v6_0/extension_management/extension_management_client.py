...
class ExtensionManagementClient(Client):
    ...
    def update_installed_extension(self, extension):
        ...
        :param :class:`<InstalledExtension> <azure.devops.v6_0.extension_management.models.InstalledExtension>` extension:
        :rtype: :class:`<InstalledExtension> <azure.devops.v6_0.extension_management.models.InstalledExtension>`
        """
