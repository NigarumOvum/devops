...
class GraphClient(Client):
    ...
    def get_avatar(self, subject_descriptor, size=None, format=None):
        ...
        :param str size:
        :param str format:
        :rtype: :class:`<Avatar> <azure.devops.v6_0.graph.models.Avatar>`
        """
        route_values = {}
        if subject_descriptor is not None:
            route_values['subjectDescriptor'] = self._serialize.url('subject_descriptor', subject_descriptor, 'str')
    ...
    def set_avatar(self, avatar, subject_descriptor):
        """SetAvatar.
        [Preview API]
        :param :class:`<Avatar> <azure.devops.v6_0.graph.models.Avatar>` avatar:
        :param str subject_descriptor:
        """
        route_values = {}
        if subject_descriptor is not None:
    ...
    def get_descriptor(self, storage_key):
        ...
        :rtype: :class:`<GraphDescriptorResult> <azure.devops.v6_0.graph.models.GraphDescriptorResult>`
        """
        route_values = {}
    ...
    def create_group(self, creation_context, scope_descriptor=None, group_descriptors=None):
        ...
        :param :class:`<GraphGroupCreationContext> <azure.devops.v6_0.graph.models.GraphGroupCreationContext>` creation_context: The subset of the full graph group used to uniquely find the graph subject in an external provider.
        ...
        :rtype: :class:`<GraphGroup> <azure.devops.v6_0.graph.models.GraphGroup>`
        """
        query_parameters = {}
    ...
    def list_groups(self, scope_descriptor=None, subject_types=None, continuation_token=None):
        ...
        :rtype: :class:`<PagedGraphGroups> <azure.devops.v6_0.graph.models.PagedGraphGroups>`
        """
        query_parameters = {}
        if scope_descriptor is not None:
            query_parameters['scopeDescriptor'] = self._serialize.query('scope_descriptor', scope_descriptor, 'str')
    ...
    def update_group(self, group_descriptor, patch_document):
        ...
        :param :class:`<[JsonPatchOperation]> <azure.devops.v6_0.graph.models.[JsonPatchOperation]>` patch_document: The JSON+Patch document containing the fields to alter.
        :rtype: :class:`<GraphGroup> <azure.devops.v6_0.graph.models.GraphGroup>`
        """
        route_values = {}
        if group_descriptor is not None:
    ...
    def add_membership(self, subject_descriptor, container_descriptor):
        ...
        :rtype: :class:`<GraphMembership> <azure.devops.v6_0.graph.models.GraphMembership>`
        """
        route_values = {}
        if subject_descriptor is not None:
            route_values['subjectDescriptor'] = self._serialize.url('subject_descriptor', subject_descriptor, 'str')
    ...
    def get_membership_state(self, subject_descriptor):
        ...
        :rtype: :class:`<GraphMembershipState> <azure.devops.v6_0.graph.models.GraphMembershipState>`
        """
        route_values = {}
        if subject_descriptor is not None:
            route_values['subjectDescriptor'] = self._serialize.url('subject_descriptor', subject_descriptor, 'str')
    ...
    def get_provider_info(self, user_descriptor):
        ...
        :rtype: :class:`<GraphProviderInfo> <azure.devops.v6_0.graph.models.GraphProviderInfo>`
        """
        route_values = {}
    ...
    def request_access(self, jsondocument):
        """RequestAccess.
        [Preview API]
        :param :class:`<object> <azure.devops.v6_0.graph.models.object>` jsondocument:
        """
    ...
    def get_storage_key(self, subject_descriptor):
        ...
        :param str subject_descriptor:
        :rtype: :class:`<GraphStorageKeyResult> <azure.devops.v6_0.graph.models.GraphStorageKeyResult>`
        """
        route_values = {}
        if subject_descriptor is not None:
            route_values['subjectDescriptor'] = self._serialize.url('subject_descriptor', subject_descriptor, 'str')
    ...
    def lookup_subjects(self, subject_lookup):
        ...
        :param :class:`<GraphSubjectLookup> <azure.devops.v6_0.graph.models.GraphSubjectLookup>` subject_lookup: A list of descriptors that specifies a subset of subjects to retrieve. Each descriptor uniquely identifies the subject across all instance scopes, but only at a single point in time.
        :rtype: {GraphSubject}
        """
    ...
    def create_user(self, creation_context, group_descriptors=None):
        ...
        :param :class:`<GraphUserCreationContext> <azure.devops.v6_0.graph.models.GraphUserCreationContext>` creation_context: The subset of the full graph user used to uniquely find the graph subject in an external provider.
        :param [str] group_descriptors: A comma separated list of descriptors of groups you want the graph user to join
        :rtype: :class:`<GraphUser> <azure.devops.v6_0.graph.models.GraphUser>`
        """
        query_parameters = {}
        if group_descriptors is not None:
            group_descriptors = ",".join(group_descriptors)
    ...
    def list_users(self, subject_types=None, continuation_token=None, scope_descriptor=None):
        ...
        :rtype: :class:`<PagedGraphUsers> <azure.devops.v6_0.graph.models.PagedGraphUsers>`
        """
        query_parameters = {}
        if subject_types is not None:
            subject_types = ",".join(subject_types)
    ...
    def update_user(self, update_context, user_descriptor):
        ...
        :param :class:`<GraphUserUpdateContext> <azure.devops.v6_0.graph.models.GraphUserUpdateContext>` update_context: The subset of the full graph user used to uniquely find the graph subject in an external provider.
