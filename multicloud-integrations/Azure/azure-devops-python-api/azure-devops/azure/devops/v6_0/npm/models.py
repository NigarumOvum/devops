...
class NpmPackagesBatchRequest(Model):
    ...
    :type data: :class:`BatchOperationData <azure.devops.v6_0.npm.models.BatchOperationData>`
    ...
    :type packages: list of :class:`MinimalPackageDetails <azure.devops.v6_0.npm.models.MinimalPackageDetails>`
    """
...
class Package(Model):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v6_0.npm.models.ReferenceLinks>`
    ...
    :type source_chain: list of :class:`UpstreamSourceInfo <azure.devops.v6_0.npm.models.UpstreamSourceInfo>`
...
class PackageVersionDetails(Model):
    ...
    :type views: :class:`JsonPatchOperation <azure.devops.v6_0.npm.models.JsonPatchOperation>`
    """
