...
class Change(Model):
    ...
    :type new_content: :class:`ItemContent <azure.devops.v6_0.tfvc.models.ItemContent>`
...
class GitRepository(Model):
    """
    :param _links:
    :type _links: :class:`ReferenceLinks <azure.devops.v6_0.tfvc.models.ReferenceLinks>`
    ...
    :type parent_repository: :class:`GitRepositoryRef <azure.devops.v6_0.tfvc.models.GitRepositoryRef>`
    :param project:
    :type project: :class:`TeamProjectReference <azure.devops.v6_0.tfvc.models.TeamProjectReference>`
    :param remote_url:
    :type remote_url: str
...
class GitRepositoryRef(Model):
    ...
    :type collection: :class:`TeamProjectCollectionReference <azure.devops.v6_0.tfvc.models.TeamProjectCollectionReference>`
    :param id:
    :type id: str
    :param is_fork: True if the repository was created as a fork
    :type is_fork: bool
...
class ItemModel(Model):
    ...
    :type content_metadata: :class:`FileContentMetadata <azure.devops.v6_0.tfvc.models.FileContentMetadata>`
    :param is_folder:
    :type is_folder: bool
    :param is_sym_link:
...
class TfvcChange(Change):
    ...
    :type merge_sources: list of :class:`TfvcMergeSource <azure.devops.v6_0.tfvc.models.TfvcMergeSource>`
...
class TfvcChangesetRef(Model):
    ...
    :type author: :class:`IdentityRef <azure.devops.v6_0.tfvc.models.IdentityRef>`
    :param changeset_id: Changeset Id.
    :type changeset_id: int
    :param checked_in_by: Alias or display name of user.
    :type checked_in_by: :class:`IdentityRef <azure.devops.v6_0.tfvc.models.IdentityRef>`
...
class TfvcChangesetSearchCriteria(Model):
    ...
    :type item_path: str
    :param mappings:
    :type mappings: list of :class:`TfvcMappingFilter <azure.devops.v6_0.tfvc.models.TfvcMappingFilter>`
...
class TfvcItemRequestData(Model):
    ...
    :type item_descriptors: list of :class:`TfvcItemDescriptor <azure.devops.v6_0.tfvc.models.TfvcItemDescriptor>`
    """
...
class TfvcLabelRef(Model):
    ...
    :type owner: :class:`IdentityRef <azure.devops.v6_0.tfvc.models.IdentityRef>`
    :param url: Label Url.
    :type url: str
    """
...
class TfvcPolicyOverrideInfo(Model):
    ...
    :type policy_failures: list of :class:`TfvcPolicyFailureInfo <azure.devops.v6_0.tfvc.models.TfvcPolicyFailureInfo>`
    """
...
class VstsInfo(Model):
    ...
    :type collection: :class:`TeamProjectCollectionReference <azure.devops.v6_0.tfvc.models.TeamProjectCollectionReference>`
    :param repository:
    :type repository: :class:`GitRepository <azure.devops.v6_0.tfvc.models.GitRepository>`
    :param server_url:
    :type server_url: str
    """
...
class TfvcChangeset(TfvcChangesetRef):
    ...
    :type changes: list of :class:`TfvcChange <azure.devops.v6_0.tfvc.models.TfvcChange>`
    :param checkin_notes: List of Checkin Notes for the changeset.
    :type checkin_notes: list of :class:`CheckinNote <azure.devops.v6_0.tfvc.models.CheckinNote>`
    ...
    :type policy_override: :class:`TfvcPolicyOverrideInfo <azure.devops.v6_0.tfvc.models.TfvcPolicyOverrideInfo>`
    ...
    :type work_items: list of :class:`AssociatedWorkItem <azure.devops.v6_0.tfvc.models.AssociatedWorkItem>`
    """
...
class TfvcLabel(TfvcLabelRef):
    ...
    :type items: list of :class:`TfvcItem <azure.devops.v6_0.tfvc.models.TfvcItem>`
    """
...
class TfvcShelveset(TfvcShelvesetRef):
    ...
    :type notes: list of :class:`CheckinNote <azure.devops.v6_0.tfvc.models.CheckinNote>`
...
class TfvcBranch(TfvcBranchRef):
    ...
    :type children: list of :class:`TfvcBranch <azure.devops.v6_0.tfvc.models.TfvcBranch>`
    :param mappings: List of branch mappings.
    :type mappings: list of :class:`TfvcBranchMapping <azure.devops.v6_0.tfvc.models.TfvcBranchMapping>`
    :param parent: Path of the branch's parent.
    :type parent: :class:`TfvcShallowBranchRef <azure.devops.v6_0.tfvc.models.TfvcShallowBranchRef>`
    :param related_branches: List of paths of the related branches.
    :type related_branches: list of :class:`TfvcShallowBranchRef <azure.devops.v6_0.tfvc.models.TfvcShallowBranchRef>`
    """
