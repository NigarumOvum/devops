...
class ContributionsClient(Client):
    ...
    def query_contribution_nodes(self, query):
        ...
        :param :class:`<ContributionNodeQuery> <azure.devops.v6_0.contributions.models.ContributionNodeQuery>` query:
        :rtype: :class:`<ContributionNodeQueryResult> <azure.devops.v6_0.contributions.models.ContributionNodeQueryResult>`
        """
    ...
    def query_data_providers(self, query, scope_name=None, scope_value=None):
        """QueryDataProviders.
        [Preview API]
        :param :class:`<DataProviderQuery> <azure.devops.v6_0.contributions.models.DataProviderQuery>` query:
        :param str scope_name:
        :param str scope_value:
        :rtype: :class:`<DataProviderResult> <azure.devops.v6_0.contributions.models.DataProviderResult>`
        """
        route_values = {}
    ...
    def get_installed_extension_by_name(self, publisher_name, extension_name, asset_types=None):
        ...
        :param [str] asset_types:
        :rtype: :class:`<InstalledExtension> <azure.devops.v6_0.contributions.models.InstalledExtension>`
        """
        route_values = {}
