...
class TaskAgentClient(Client):
    ...
    def add_agent(self, agent, pool_id):
        ...
        :param :class:`<TaskAgent> <azure.devops.v6_0.task_agent.models.TaskAgent>` agent: Details about the agent being added
        :param int pool_id: The agent pool in which to add the agent
        :rtype: :class:`<TaskAgent> <azure.devops.v6_0.task_agent.models.TaskAgent>`
        """
        route_values = {}
    ...
    def replace_agent(self, agent, pool_id, agent_id):
        ...
        :param :class:`<TaskAgent> <azure.devops.v6_0.task_agent.models.TaskAgent>` agent: Updated details about the replacing agent
    ...
    def update_agent(self, agent, pool_id, agent_id):
        ...
        :param :class:`<TaskAgent> <azure.devops.v6_0.task_agent.models.TaskAgent>` agent: Updated details about the agent
        :param int pool_id: The agent pool to use
    ...
    def add_deployment_group(self, deployment_group, project):
        ...
        :param :class:`<DeploymentGroupCreateParameter> <azure.devops.v6_0.task_agent.models.DeploymentGroupCreateParameter>` deployment_group: Deployment group to create.
        :param str project: Project ID or project name
        :rtype: :class:`<DeploymentGroup> <azure.devops.v6_0.task_agent.models.DeploymentGroup>`
        """
        route_values = {}
    ...
    def update_deployment_group(self, deployment_group, project, deployment_group_id):
        ...
        :param :class:`<DeploymentGroupUpdateParameter> <azure.devops.v6_0.task_agent.models.DeploymentGroupUpdateParameter>` deployment_group: Deployment group to update.
        :param str project: Project ID or project name
        :param int deployment_group_id: ID of the deployment group.
        :rtype: :class:`<DeploymentGroup> <azure.devops.v6_0.task_agent.models.DeploymentGroup>`
        """
    ...
    def add_agent_pool(self, pool):
        ...
        :param :class:`<TaskAgentPool> <azure.devops.v6_0.task_agent.models.TaskAgentPool>` pool: Details about the new agent pool
        :rtype: :class:`<TaskAgentPool> <azure.devops.v6_0.task_agent.models.TaskAgentPool>`
        """
    ...
    def update_agent_pool(self, pool, pool_id):
        ...
        :param :class:`<TaskAgentPool> <azure.devops.v6_0.task_agent.models.TaskAgentPool>` pool: Updated agent pool details
    ...
    def add_agent_queue(self, queue, project=None, authorize_pipelines=None):
        ...
        :param :class:`<TaskAgentQueue> <azure.devops.v6_0.task_agent.models.TaskAgentQueue>` queue: Details about the queue to create
        :param str project: Project ID or project name
        :param bool authorize_pipelines: Automatically authorize this queue when using YAML
        :rtype: :class:`<TaskAgentQueue> <azure.devops.v6_0.task_agent.models.TaskAgentQueue>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_deployment_target(self, project, deployment_group_id, target_id, expand=None):
        ...
        :param str expand: Include these additional details in the returned objects.
        :rtype: :class:`<DeploymentMachine> <azure.devops.v6_0.task_agent.models.DeploymentMachine>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def add_task_group(self, task_group, project):
        ...
        :param :class:`<TaskGroupCreateParameter> <azure.devops.v6_0.task_agent.models.TaskGroupCreateParameter>` task_group: Task group object to create.
        :param str project: Project ID or project name
        :rtype: :class:`<TaskGroup> <azure.devops.v6_0.task_agent.models.TaskGroup>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_task_group(self, task_group, project, task_group_id=None):
        ...
        :param :class:`<TaskGroupUpdateParameter> <azure.devops.v6_0.task_agent.models.TaskGroupUpdateParameter>` task_group: Task group to update.
        :param str project: Project ID or project name
    ...
    def add_variable_group(self, variable_group_parameters):
        ...
        :param :class:`<VariableGroupParameters> <azure.devops.v6_0.task_agent.models.VariableGroupParameters>` variable_group_parameters:
        :rtype: :class:`<VariableGroup> <azure.devops.v6_0.task_agent.models.VariableGroup>`
        """
