...
class SymbolClient(Client):
    ...
    def create_requests(self, request_to_create):
        ...
        :param :class:`<Request> <azure.devops.v6_0.symbol.models.Request>` request_to_create: The symbol request to create.
        :rtype: :class:`<Request> <azure.devops.v6_0.symbol.models.Request>`
        """
    ...
    def create_requests_request_id_debug_entries(self, batch, request_id, collection):
        ...
        :param :class:`<DebugEntryCreateBatch> <azure.devops.v6_0.symbol.models.DebugEntryCreateBatch>` batch: A batch that contains debug entries to create.
    ...
    def update_requests_request_id(self, update_request, request_id):
        ...
        :param :class:`<Request> <azure.devops.v6_0.symbol.models.Request>` update_request: The symbol request.
        :param str request_id: The symbol request identifier.
        :rtype: :class:`<Request> <azure.devops.v6_0.symbol.models.Request>`
        """
        route_values = {}
