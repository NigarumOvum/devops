...
class TokenAdminClient(Client):
    ...
    def list_personal_access_tokens(self, subject_descriptor, page_size=None, continuation_token=None, is_public=None):
        ...
        :param :class:`<str> <azure.devops.v6_0.token_admin.models.str>` subject_descriptor: The descriptor of the target user.
        ...
        :rtype: :class:`<TokenAdminPagedSessionTokens> <azure.devops.v6_0.token_admin.models.TokenAdminPagedSessionTokens>`
        """
        route_values = {}
    ...
    def create_revocation_rule(self, revocation_rule):
        ...
        :param :class:`<TokenAdminRevocationRule> <azure.devops.v6_0.token_admin.models.TokenAdminRevocationRule>` revocation_rule: The revocation rule to create. The rule must specify a space-separated list of scopes, after which preexisting OAuth authorizations that match that any of the scopes will be rejected. For a list of all OAuth scopes supported by VSTS, see: https://docs.microsoft.com/en-us/vsts/integrate/get-started/authentication/oauth?view=vsts#scopes The rule may also specify the time before which to revoke tokens.
        """
