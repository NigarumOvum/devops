...
class CloneOperationCommonResponse(Model):
    ...
    :type clone_statistics: :class:`CloneStatistics <azure.devops.v6_0.test_plan.models.CloneStatistics>`
    ...
    :type links: :class:`ReferenceLinks <azure.devops.v6_0.test_plan.models.ReferenceLinks>`
...
class CloneTestPlanOperationInformation(Model):
    ...
    :type clone_options: :class:`CloneOptions <azure.devops.v6_0.test_plan.models.CloneOptions>`
    :param destination_test_plan: Information of destination Test Plan
    :type destination_test_plan: :class:`TestPlan <azure.devops.v6_0.test_plan.models.TestPlan>`
    :param source_test_plan: Information of source Test Plan
    :type source_test_plan: :class:`SourceTestplanResponse <azure.devops.v6_0.test_plan.models.SourceTestplanResponse>`
    """
...
class CloneTestPlanParams(Model):
    ...
    :type destination_test_plan: :class:`DestinationTestPlanCloneParams <azure.devops.v6_0.test_plan.models.DestinationTestPlanCloneParams>`
    :param source_test_plan: Information about source Test Plan
    :type source_test_plan: :class:`SourceTestPlanInfo <azure.devops.v6_0.test_plan.models.SourceTestPlanInfo>`
    """
...
class CloneTestSuiteOperationInformation(Model):
    ...
    :type cloned_test_suite: :class:`TestSuiteReferenceWithProject <azure.devops.v6_0.test_plan.models.TestSuiteReferenceWithProject>`
    :param clone_operation_response: Various information related to the clone
    :type clone_operation_response: :class:`CloneOperationCommonResponse <azure.devops.v6_0.test_plan.models.CloneOperationCommonResponse>`
    :param clone_options: Test Plan Clone create parameters
    :type clone_options: :class:`CloneOptions <azure.devops.v6_0.test_plan.models.CloneOptions>`
    ...
    :type source_test_suite: :class:`TestSuiteReferenceWithProject <azure.devops.v6_0.test_plan.models.TestSuiteReferenceWithProject>`
    """
...
class PointAssignment(Configuration):
    ...
    :type tester: :class:`IdentityRef <azure.devops.v6_0.test_plan.models.IdentityRef>`
    """
...
class SuiteTestCaseCreateUpdateParameters(Model):
    ...
    :type point_assignments: list of :class:`Configuration <azure.devops.v6_0.test_plan.models.Configuration>`
    :param work_item: Id of Test Case to be updated or created
    :type work_item: :class:`WorkItem <azure.devops.v6_0.test_plan.models.WorkItem>`
    """
...
class TestCase(Model):
    ...
    :type point_assignments: list of :class:`PointAssignment <azure.devops.v6_0.test_plan.models.PointAssignment>`
    ...
    :type test_plan: :class:`TestPlanReference <azure.devops.v6_0.test_plan.models.TestPlanReference>`
    :param test_suite: Test Suite under which the Test Case is
    :type test_suite: :class:`TestSuiteReference <azure.devops.v6_0.test_plan.models.TestSuiteReference>`
    :param work_item: Work Item details of the TestCase
    :type work_item: :class:`WorkItemDetails <azure.devops.v6_0.test_plan.models.WorkItemDetails>`
    """
...
class TestCaseAssociatedResult(Model):
    ...
    :param configuration:
    :type configuration: :class:`TestConfigurationReference <azure.devops.v6_0.test_plan.models.TestConfigurationReference>`
    :param outcome:
    :type outcome: object
    :param plan:
    :type plan: :class:`TestPlanReference <azure.devops.v6_0.test_plan.models.TestPlanReference>`
    :param point_id:
    :type point_id: int
    :param result_id:
    :type result_id: int
    :param run_by:
    :type run_by: :class:`IdentityRef <azure.devops.v6_0.test_plan.models.IdentityRef>`
    :param run_id:
    :type run_id: int
    :param suite:
    :type suite: :class:`TestSuiteReference <azure.devops.v6_0.test_plan.models.TestSuiteReference>`
    :param tester:
    :type tester: :class:`IdentityRef <azure.devops.v6_0.test_plan.models.IdentityRef>`
    """
...
class TestCaseReference(Model):
    ...
    :type assigned_to: :class:`IdentityRef <azure.devops.v6_0.test_plan.models.IdentityRef>`
...
class TestCaseResultsData(Model):
    ...
    :type context_point: :class:`TestPointDetailedReference <azure.devops.v6_0.test_plan.models.TestPointDetailedReference>`
    :param results: Use to store the results displayed in the table
    :type results: list of :class:`TestCaseAssociatedResult <azure.devops.v6_0.test_plan.models.TestCaseAssociatedResult>`
...
class TestConfigurationCreateUpdateParameters(Model):
    ...
    :type values: list of :class:`NameValuePair <azure.devops.v6_0.test_plan.models.NameValuePair>`
    """
...
class TestPlanCreateParams(Model):
    ...
    :type automated_test_environment: :class:`TestEnvironment <azure.devops.v6_0.test_plan.models.TestEnvironment>`
    :param automated_test_settings:
    :type automated_test_settings: :class:`TestSettings <azure.devops.v6_0.test_plan.models.TestSettings>`
    :param build_definition: The Build Definition that generates a build associated with this test plan.
    :type build_definition: :class:`BuildDefinitionReference <azure.devops.v6_0.test_plan.models.BuildDefinitionReference>`
    ...
    :type manual_test_environment: :class:`TestEnvironment <azure.devops.v6_0.test_plan.models.TestEnvironment>`
    :param manual_test_settings:
    :type manual_test_settings: :class:`TestSettings <azure.devops.v6_0.test_plan.models.TestSettings>`
    :param name: Name of the test plan.
    :type name: str
    :param owner: Owner of the test plan.
    :type owner: :class:`IdentityRef <azure.devops.v6_0.test_plan.models.IdentityRef>`
    ...
    :type release_environment_definition: :class:`ReleaseEnvironmentDefinitionReference <azure.devops.v6_0.test_plan.models.ReleaseEnvironmentDefinitionReference>`
    ...
    :type test_outcome_settings: :class:`TestOutcomeSettings <azure.devops.v6_0.test_plan.models.TestOutcomeSettings>`
    """
...
class TestPlansHubRefreshData(Model):
    ...
    :param test_cases:
    :type test_cases: list of :class:`TestCase <azure.devops.v6_0.test_plan.models.TestCase>`
    :param test_cases_continuation_token:
    :type test_cases_continuation_token: str
    :param test_plan:
    :type test_plan: :class:`TestPlanDetailedReference <azure.devops.v6_0.test_plan.models.TestPlanDetailedReference>`
    :param test_point_page_size:
    :type test_point_page_size: int
    :param test_points:
    :type test_points: list of :class:`TestPoint <azure.devops.v6_0.test_plan.models.TestPoint>`
    :param test_points_continuation_token:
    :type test_points_continuation_token: str
    :param test_suites:
    :type test_suites: list of :class:`TestSuite <azure.devops.v6_0.test_plan.models.TestSuite>`
...
class TestPoint(Model):
    ...
    :type last_updated_by: :class:`IdentityRef <azure.devops.v6_0.test_plan.models.IdentityRef>`
    ...
    :type results: :class:`TestPointResults <azure.devops.v6_0.test_plan.models.TestPointResults>`
    :param test_case_reference: Test Case Reference
    :type test_case_reference: :class:`TestCaseReference <azure.devops.v6_0.test_plan.models.TestCaseReference>`
...
class TestPointResults(Model):
    ...
    :type last_result_details: :class:`LastResultDetails <azure.devops.v6_0.test_plan.models.LastResultDetails>`
...
class TestPointUpdateParams(Model):
    ...
    :type results: :class:`Results <azure.devops.v6_0.test_plan.models.Results>`
...
class TestSuiteCreateUpdateCommonParams(Model):
    ...
    :type default_configurations: list of :class:`TestConfigurationReference <azure.devops.v6_0.test_plan.models.TestConfigurationReference>`
    :param default_testers: Test suite default testers.
    :type default_testers: list of :class:`IdentityRef <azure.devops.v6_0.test_plan.models.IdentityRef>`
    ...
    :type parent_suite: :class:`TestSuiteReference <azure.devops.v6_0.test_plan.models.TestSuiteReference>`
...
class TestPlan(TestPlanUpdateParams):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v6_0.test_plan.models.ReferenceLinks>`
    :param id: ID of the test plan.
    :type id: int
    ...
    :type root_suite: :class:`TestSuiteReference <azure.devops.v6_0.test_plan.models.TestSuiteReference>`
    :param updated_by: Identity Reference for the last update of the test plan
    :type updated_by: :class:`IdentityRef <azure.devops.v6_0.test_plan.models.IdentityRef>`
...
class TestSuite(TestSuiteCreateParams):
    ...
    :type children: list of :class:`TestSuite <azure.devops.v6_0.test_plan.models.TestSuite>`
