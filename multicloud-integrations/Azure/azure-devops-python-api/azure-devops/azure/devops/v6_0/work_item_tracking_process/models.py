...
class Section(Model):
    ...
    :type groups: list of :class:`Group <azure.devops.v6_0.work_item_tracking.models.Group>`
    :param id: The id for the layout node.
    :type id: str
    :param overridden: A value indicating whether this layout node has been overridden by a child layout.
    :type overridden: bool
...
class WorkItemBehavior(Model):
    ...
    :type description: str
    :param fields:
    :type fields: list of :class:`WorkItemBehaviorField <azure.devops.v6_0.work_item_tracking.models.WorkItemBehaviorField>`
    :param id:
    :type id: str
    :param inherits:
    :type inherits: :class:`WorkItemBehaviorReference <azure.devops.v6_0.work_item_tracking.models.WorkItemBehaviorReference>`
    :param name:
    :type name: str
    :param overriden:
    :type overriden: bool
...
class WorkItemTypeBehavior(Model):
    ...
    :type behavior: :class:`WorkItemBehaviorReference <azure.devops.v6_0.work_item_tracking.models.WorkItemBehaviorReference>`
