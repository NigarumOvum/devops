...
class IdentityClient(Client):
    ...
    def create_or_bind_with_claims(self, source_identity):
        ...
        [Preview API]
        :param :class:`<Identity> <azure.devops.v5_1.identity.models.Identity>` source_identity:
    ...
    def get_descriptor_by_id(self, id, is_master_id=None):
        ...
        :rtype: :class:`<str> <azure.devops.v5_1.identity.models.str>`
        """
        route_values = {}
        if id is not None:
    ...
    def read_identity_batch(self, batch_info):
        """ReadIdentityBatch.
        [Preview API]
        :param :class:`<IdentityBatchInfo> <azure.devops.v5_1.identity.models.IdentityBatchInfo>` batch_info:
        :rtype: [Identity]
        """
    ...
    def get_identity_snapshot(self, scope_id):
        ...
        [Preview API]
        :param str scope_id:
        :rtype: :class:`<IdentitySnapshot> <azure.devops.v5_1.identity.models.IdentitySnapshot>`
        """
        route_values = {}
        if scope_id is not None:
    ...
    def create_scope(self, info, scope_id):
        """CreateScope.
        [Preview API]
        :param :class:`<CreateScopeInfo> <azure.devops.v5_1.identity.models.CreateScopeInfo>` info:
        :param str scope_id:
        :rtype: :class:`<IdentityScope> <azure.devops.v5_1.identity.models.IdentityScope>`
        """
        route_values = {}
        if scope_id is not None:
            route_values['scopeId'] = self._serialize.url('scope_id', scope_id, 'str')
    ...
    def update_scope(self, patch_document, scope_id):
        """UpdateScope.
        [Preview API]
        :param :class:`<[JsonPatchOperation]> <azure.devops.v5_1.identity.models.[JsonPatchOperation]>` patch_document:
        :param str scope_id:
        """
        route_values = {}
        if scope_id is not None:
    ...
    def get_signed_in_token(self):
        """GetSignedInToken.
        [Preview API]
        :rtype: :class:`<AccessTokenResult> <azure.devops.v5_1.identity.models.AccessTokenResult>`
        """
        response = self._send(http_method='GET',
    ...
    def get_tenant(self, tenant_id):
        ...
        [Preview API]
        :param str tenant_id:
        :rtype: :class:`<TenantInfo> <azure.devops.v5_1.identity.models.TenantInfo>`
        """
        route_values = {}
