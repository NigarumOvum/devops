...
class BatchNotificationOperation(Model):
    ...
    :type notification_query_conditions: list of :class:`NotificationQueryCondition <azure.devops.v5_1.notification.models.NotificationQueryCondition>`
    """
...
class ExpressionFilterModel(Model):
    ...
    :type groups: list of :class:`ExpressionFilterGroup <azure.devops.v5_1.notification.models.ExpressionFilterGroup>`
...
class NotificationEventFieldType(Model):
    ...
    :type operator_constraints: list of :class:`OperatorConstraint <azure.devops.v5_1.notification.models.OperatorConstraint>`
    :param operators: Gets or sets the list of operators that this type supports.
    :type operators: list of :class:`NotificationEventFieldOperator <azure.devops.v5_1.notification.models.NotificationEventFieldOperator>`
    ...
    :type value: :class:`ValueDefinition <azure.devops.v5_1.notification.models.ValueDefinition>`
    """
...
class NotificationEventPublisher(Model):
    ...
    :type subscription_management_info: :class:`SubscriptionManagement <azure.devops.v5_1.notification.models.SubscriptionManagement>`
    :param url:
    :type url: str
    """
...
class NotificationEventType(Model):
    ...
    :type event_publisher: :class:`NotificationEventPublisher <azure.devops.v5_1.notification.models.NotificationEventPublisher>`
    :param fields:
    :type fields: dict
    :param has_initiator:
    ...
    :type name: str
    :param roles:
    :type roles: list of :class:`NotificationEventRole <azure.devops.v5_1.notification.models.NotificationEventRole>`
...
class NotificationReason(Model):
    ...
    :type target_identities: list of :class:`IdentityRef <azure.devops.v5_1.notification.models.IdentityRef>`
    """
...
class NotificationStatistic(Model):
    ...
    :type type: object
    :param user:
    :type user: :class:`IdentityRef <azure.devops.v5_1.notification.models.IdentityRef>`
    """
...
class NotificationSubscription(Model):
    ...
    :type diagnostics: :class:`SubscriptionDiagnostics <azure.devops.v5_1.notification.models.SubscriptionDiagnostics>`
    ...
    :type last_modified_by: :class:`IdentityRef <azure.devops.v5_1.notification.models.IdentityRef>`
    ...
    :type scope: :class:`SubscriptionScope <azure.devops.v5_1.notification.models.SubscriptionScope>`
    ...
    :type subscriber: :class:`IdentityRef <azure.devops.v5_1.notification.models.IdentityRef>`
    ...
    :type user_settings: :class:`SubscriptionUserSettings <azure.devops.v5_1.notification.models.SubscriptionUserSettings>`
    """
...
class NotificationSubscriptionTemplate(Model):
    ...
    :type notification_event_information: :class:`NotificationEventType <azure.devops.v5_1.notification.models.NotificationEventType>`
    :param type:
    :type type: object
    """
...
class SubscriptionEvaluationRequest(Model):
    ...
    :type subscription_create_parameters: :class:`NotificationSubscriptionCreateParameters <azure.devops.v5_1.notification.models.NotificationSubscriptionCreateParameters>`
    """
...
class SubscriptionEvaluationResult(Model):
    ...
    :type events: :class:`EventsEvaluationResult <azure.devops.v5_1.notification.models.EventsEvaluationResult>`
    ...
    :type notifications: :class:`NotificationsEvaluationResult <azure.devops.v5_1.notification.models.NotificationsEvaluationResult>`
    """
...
class VssNotificationEvent(Model):
    ...
    :type scopes: list of :class:`EventScope <azure.devops.v5_1.microsoft._visual_studio._services._web_api.models.EventScope>`
...
class FieldInputValues(InputValues):
    ...
    :type default_value: str
    :param error: Errors encountered while computing dynamic values.
    :type error: :class:`InputValuesError <azure.devops.v5_1.notification.models.InputValuesError>`
    :param input_id: The id of the input
    :type input_id: str
    :param is_disabled: Should this input be disabled
    :type is_disabled: bool
    ...
    :type is_read_only: bool
    :param possible_values: Possible values that this input can take
    :type possible_values: list of :class:`InputValue <azure.devops.v5_1.notification.models.InputValue>`
    :param operators:
    :type operators: str
    """
...
class FieldValuesQuery(InputValuesQuery):
    ...
    :type resource: object
    :param input_values:
    :type input_values: list of :class:`FieldInputValues <azure.devops.v5_1.notification.models.FieldInputValues>`
    :param scope:
    :type scope: str
    """
