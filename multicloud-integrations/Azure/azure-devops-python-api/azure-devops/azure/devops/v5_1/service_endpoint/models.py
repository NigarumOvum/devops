...
class AzureManagementGroupQueryResult(Model):
    ...
    :type value: list of :class:`AzureManagementGroup <azure.devops.v5_1.service_endpoint.models.AzureManagementGroup>`
    """
...
class AzureSubscriptionQueryResult(Model):
    ...
    :type error_message: str
    :param value:
    :type value: list of :class:`AzureSubscription <azure.devops.v5_1.service_endpoint.models.AzureSubscription>`
    """
...
class OAuthConfiguration(Model):
    ...
    :type created_by: :class:`IdentityRef <azure.devops.v5_1.service_endpoint.models.IdentityRef>`
    ...
    :type modified_by: :class:`IdentityRef <azure.devops.v5_1.service_endpoint.models.IdentityRef>`
...
class ServiceEndpoint(Model):
    ...
    :type operation_status: :class:`object <azure.devops.v5_1.service_endpoint.models.object>`
    ...
    :type readers_group: :class:`IdentityRef <azure.devops.v5_1.service_endpoint.models.IdentityRef>`
...
class ServiceEndpointAuthenticationScheme(Model):
    ...
    :type input_descriptors: list of :class:`InputDescriptor <azure.devops.v5_1.service_endpoint.models.InputDescriptor>`
...
class ServiceEndpointExecutionData(Model):
    ...
    :type owner: :class:`ServiceEndpointExecutionOwner <azure.devops.v5_1.service_endpoint.models.ServiceEndpointExecutionOwner>`
...
class ServiceEndpointRequest(Model):
    ...
    :type result_transformation_details: :class:`ResultTransformationDetails <azure.devops.v5_1.service_endpoint.models.ResultTransformationDetails>`
    :param service_endpoint_details: Gets or sets the service endpoint details for the service endpoint request.
    :type service_endpoint_details: :class:`ServiceEndpointDetails <azure.devops.v5_1.service_endpoint.models.ServiceEndpointDetails>`
    """
...
class ServiceEndpointRequestResult(Model):
    ...
    :type result: :class:`object <azure.devops.v5_1.service_endpoint.models.object>`
...
class ServiceEndpointType(Model):
    ...
    :type data_sources: list of :class:`DataSource <azure.devops.v5_1.service_endpoint.models.DataSource>`
    :param dependency_data: Dependency data of service endpoint type.
    :type dependency_data: list of :class:`DependencyData <azure.devops.v5_1.service_endpoint.models.DependencyData>`
