...
class Dashboard(Model):
    ...
    :type widgets: list of :class:`Widget <azure.devops.v5_1.dashboard.models.Widget>`
    """
...
class DashboardGroup(Model):
    ...
    :type dashboard_entries: list of :class:`DashboardGroupEntry <azure.devops.v5_1.dashboard.models.DashboardGroupEntry>`
...
class Widget(Model):
    ...
    :type dashboard: :class:`Dashboard <azure.devops.v5_1.dashboard.models.Dashboard>`
    :param eTag:
    :type eTag: str
    :param id:
    :type id: str
    ...
    :type lightbox_options: :class:`LightboxOptions <azure.devops.v5_1.dashboard.models.LightboxOptions>`
    :param loading_image_url:
    :type loading_image_url: str
    :param name:
    :type name: str
    :param position:
    :type position: :class:`WidgetPosition <azure.devops.v5_1.dashboard.models.WidgetPosition>`
    :param settings:
    :type settings: str
    :param settings_version:
    :type settings_version: :class:`SemanticVersion <azure.devops.v5_1.dashboard.models.SemanticVersion>`
    :param size:
    :type size: :class:`WidgetSize <azure.devops.v5_1.dashboard.models.WidgetSize>`
    :param type_id:
    :type type_id: str
    :param url:
    :type url: str
...
class WidgetMetadataResponse(Model):
    ...
    :type widget_metadata: :class:`WidgetMetadata <azure.devops.v5_1.dashboard.models.WidgetMetadata>`
    """
...
class WidgetTypesResponse(Model):
    ...
    :type uri: str
    :param widget_types:
    :type widget_types: list of :class:`WidgetMetadata <azure.devops.v5_1.dashboard.models.WidgetMetadata>`
    """
