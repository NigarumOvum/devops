...
class GitClientBase(Client):
    ...
    def create_annotated_tag(self, tag_object, project, repository_id):
        ...
        :rtype: :class:`<GitAnnotatedTag> <azure.devops.v5_1.git.models.GitAnnotatedTag>`
        """
        route_values = {}
    ...
    def create_cherry_pick(self, cherry_pick_to_create, project, repository_id):
        ...
        :param :class:`<GitAsyncRefOperationParameters> <azure.devops.v5_1.git.models.GitAsyncRefOperationParameters>` cherry_pick_to_create:
        :param str project: Project ID or project name
    ...
    def create_fork_sync_request(self, sync_params, repository_name_or_id, project=None, include_links=None):
        ...
        :param :class:`<GitForkSyncRequestParameters> <azure.devops.v5_1.git.models.GitForkSyncRequestParameters>` sync_params: Source repository and ref mapping.
        :param str repository_name_or_id: The name or ID of the repository.
        :param str project: Project ID or project name
        :param bool include_links: True to include links
        :rtype: :class:`<GitForkSyncRequest> <azure.devops.v5_1.git.models.GitForkSyncRequest>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def create_import_request(self, import_request, project, repository_id):
        ...
        :param :class:`<GitImportRequest> <azure.devops.v5_1.git.models.GitImportRequest>` import_request: The import request to create.
        :param str project: Project ID or project name
        :param str repository_id: The name or ID of the repository.
        :rtype: :class:`<GitImportRequest> <azure.devops.v5_1.git.models.GitImportRequest>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_import_request(self, import_request_to_update, project, repository_id, import_request_id):
        ...
        :param :class:`<GitImportRequest> <azure.devops.v5_1.git.models.GitImportRequest>` import_request_to_update: The updated version of the import request. Currently, the only change allowed is setting the Status to Queued or Abandoned.
        :param str project: Project ID or project name
        :param str repository_id: The name or ID of the repository.
    ...
    def create_merge_request(self, merge_parameters, project, repository_name_or_id, include_links=None):
        ...
        :param :class:`<GitMergeParameters> <azure.devops.v5_1.git.models.GitMergeParameters>` merge_parameters: Parents commitIds and merge commit messsage.
        :param str project: Project ID or project name
        :param str repository_name_or_id: The name or ID of the repository.
        :param bool include_links: True to include links
    ...
    def create_pull_request_iteration_status(self, status, repository_id, pull_request_id, iteration_id, project=None):
        ...
        :param :class:`<GitPullRequestStatus> <azure.devops.v5_1.git.models.GitPullRequestStatus>` status: Pull request status to create.
        :param str repository_id: The repository ID of the pull request’s target branch.
        :param int pull_request_id: ID of the pull request.
        :param int iteration_id: ID of the pull request iteration.
        :param str project: Project ID or project name
        :rtype: :class:`<GitPullRequestStatus> <azure.devops.v5_1.git.models.GitPullRequestStatus>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def create_pull_request_label(self, label, repository_id, pull_request_id, project=None, project_id=None):
        ...
        :param :class:`<WebApiCreateTagRequestData> <azure.devops.v5_1.git.models.WebApiCreateTagRequestData>` label: Label to assign to the pull request.
        :param str repository_id: The repository ID of the pull request’s target branch.
        :param int pull_request_id: ID of the pull request.
        :param str project: Project ID or project name
        :param str project_id: Project ID or project name.
        :rtype: :class:`<WebApiTagDefinition> <azure.devops.v5_1.git.models.WebApiTagDefinition>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_pull_request_properties(self, repository_id, pull_request_id, project=None):
        ...
        :param int pull_request_id: ID of the pull request.
        :param str project: Project ID or project name
        :rtype: :class:`<object> <azure.devops.v5_1.git.models.object>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_pull_request_properties(self, patch_document, repository_id, pull_request_id, project=None):
        ...
        :param :class:`<[JsonPatchOperation]> <azure.devops.v5_1.git.models.[JsonPatchOperation]>` patch_document: Properties to add, replace or remove in JSON Patch format.
        :param str repository_id: The repository ID of the pull request’s target branch.
        :param int pull_request_id: ID of the pull request.
        :param str project: Project ID or project name
        :rtype: :class:`<object> <azure.devops.v5_1.git.models.object>`
    ...
    def share_pull_request(self, user_message, repository_id, pull_request_id, project=None):
        ...
        :param :class:`<ShareNotificationContext> <azure.devops.v5_1.git.models.ShareNotificationContext>` user_message:
    ...
    def create_favorite(self, favorite, project):
        ...
        :param :class:`<GitRefFavorite> <azure.devops.v5_1.git.models.GitRefFavorite>` favorite: The ref favorite to create.
        :param str project: Project ID or project name
