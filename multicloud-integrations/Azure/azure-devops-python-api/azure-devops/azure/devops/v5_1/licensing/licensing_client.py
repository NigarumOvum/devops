...
class LicensingClient(Client):
    ...
    def get_client_rights(self, right_name=None, product_version=None, edition=None, rel_type=None, include_certificate=None, canary=None, machine_id=None):
        ...
        :rtype: :class:`<ClientRightsContainer> <azure.devops.v5_1.licensing.models.ClientRightsContainer>`
        """
        route_values = {}
    ...
    def assign_account_entitlement_for_user(self, body, user_id, dont_notify_user=None, origin=None):
        ...
        :param :class:`<AccountEntitlementUpdateModel> <azure.devops.v5_1.licensing.models.AccountEntitlementUpdateModel>` body: The update model for the entitlement
    ...
    def assign_extension_to_users(self, body):
        ...
        :param :class:`<ExtensionAssignment> <azure.devops.v5_1.licensing.models.ExtensionAssignment>` body: The extension assignment details.
        :rtype: [ExtensionOperationResult]
        """
    ...
    def get_extension_license_data(self, extension_id):
        ...
        :rtype: :class:`<ExtensionLicenseData> <azure.devops.v5_1.licensing.models.ExtensionLicenseData>`
        """
        route_values = {}
        if extension_id is not None:
            route_values['extensionId'] = self._serialize.url('extension_id', extension_id, 'str')
    ...
    def register_extension_license(self, extension_license_data):
        ...
        [Preview API]
        :param :class:`<ExtensionLicenseData> <azure.devops.v5_1.licensing.models.ExtensionLicenseData>` extension_license_data:
        :rtype: bool
        """
    ...
    def get_extension_rights(self):
        """GetExtensionRights.
        [Preview API]
        :rtype: :class:`<ExtensionRightsResult> <azure.devops.v5_1.licensing.models.ExtensionRightsResult>`
        """
        response = self._send(http_method='GET',
                              location_id='5f1dbe21-f748-47c7-b5fd-3770c8bc2c08',
                              version='5.1-preview.1')
    ...
    def transfer_extensions_for_identities(self, identity_mapping):
        """TransferExtensionsForIdentities.
        [Preview API] This method transfers extensions for the given identities.
        :param [IdentityMapping] identity_mapping: The identity mapping.
        """
