...
class FeatureAvailabilityClient(Client):
    ...
    def get_feature_flag_by_name(self, name, check_feature_exists=None):
        ...
        :rtype: :class:`<FeatureFlag> <azure.devops.v6_0.feature_availability.models.FeatureFlag>`
        """
        route_values = {}
        if name is not None:
    ...
    def update_feature_flag(self, state, name, user_email=None, check_feature_exists=None, set_at_application_level_also=None):
        ...
        :param :class:`<FeatureFlagPatch> <azure.devops.v6_0.feature_availability.models.FeatureFlagPatch>` state: State that should be set
