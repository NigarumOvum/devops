...
class AccessControlEntry(Model):
    ...
    :type descriptor: :class:`str <azure.devops.v6_0.security.models.str>`
    ...
    :type extended_info: :class:`AceExtendedInformation <azure.devops.v6_0.security.models.AceExtendedInformation>`
    """
...
class PermissionEvaluationBatch(Model):
    ...
    :type evaluations: list of :class:`PermissionEvaluation <azure.devops.v6_0.security.models.PermissionEvaluation>`
    """
...
class SecurityNamespaceDescription(Model):
    ...
    :type actions: list of :class:`ActionDefinition <azure.devops.v6_0.security.models.ActionDefinition>`
