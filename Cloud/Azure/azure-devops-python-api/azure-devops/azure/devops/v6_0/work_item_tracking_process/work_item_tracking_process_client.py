...
class WorkItemTrackingProcessClient(Client):
    ...
    def create_process_behavior(self, behavior, process_id):
        ...
        :param :class:`<ProcessBehaviorCreateRequest> <azure.devops.v6_0.work_item_tracking_process.models.ProcessBehaviorCreateRequest>` behavior:
        :param str process_id: The ID of the process
        :rtype: :class:`<ProcessBehavior> <azure.devops.v6_0.work_item_tracking_process.models.ProcessBehavior>`
        """
        route_values = {}
    ...
    def update_process_behavior(self, behavior_data, process_id, behavior_ref_name):
        ...
        :param :class:`<ProcessBehaviorUpdateRequest> <azure.devops.v6_0.work_item_tracking_process.models.ProcessBehaviorUpdateRequest>` behavior_data:
        :param str process_id: The ID of the process
        :param str behavior_ref_name: The reference name of the behavior
        :rtype: :class:`<ProcessBehavior> <azure.devops.v6_0.work_item_tracking_process.models.ProcessBehavior>`
        """
    ...
    def create_control_in_group(self, control, process_id, wit_ref_name, group_id):
        ...
        :param :class:`<Control> <azure.devops.v6_0.work_item_tracking_process.models.Control>` control: The control.
        :param str process_id: The ID of the process.
        ...
        :rtype: :class:`<Control> <azure.devops.v6_0.work_item_tracking_process.models.Control>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def update_control(self, control, process_id, wit_ref_name, group_id, control_id):
        ...
        :param :class:`<Control> <azure.devops.v6_0.work_item_tracking_process.models.Control>` control: The updated control.
        :param str process_id: The ID of the process.
        :param str wit_ref_name: The reference name of the work item type.
        :param str group_id: The ID of the group.
        :param str control_id: The ID of the control.
    ...
    def add_field_to_work_item_type(self, field, process_id, wit_ref_name):
        ...
        :param :class:`<AddProcessWorkItemTypeFieldRequest> <azure.devops.v6_0.work_item_tracking_process.models.AddProcessWorkItemTypeFieldRequest>` field:
        :param str process_id: The ID of the process.
        :param str wit_ref_name: The reference name of the work item type.
        :rtype: :class:`<ProcessWorkItemTypeField> <azure.devops.v6_0.work_item_tracking_process.models.ProcessWorkItemTypeField>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def update_work_item_type_field(self, field, process_id, wit_ref_name, field_ref_name):
        ...
        :param :class:`<UpdateProcessWorkItemTypeFieldRequest> <azure.devops.v6_0.work_item_tracking_process.models.UpdateProcessWorkItemTypeFieldRequest>` field:
        :param str process_id: The ID of the process.
        :param str wit_ref_name: The reference name of the work item type.
        :param str field_ref_name: The reference name of the field.
        :rtype: :class:`<ProcessWorkItemTypeField> <azure.devops.v6_0.work_item_tracking_process.models.ProcessWorkItemTypeField>`
    ...
    def add_group(self, group, process_id, wit_ref_name, page_id, section_id):
        ...
        :param :class:`<Group> <azure.devops.v6_0.work_item_tracking_process.models.Group>` group: The group.
        :param str process_id: The ID of the process.
        :param str wit_ref_name: The reference name of the work item type.
        :param str page_id: The ID of the page to add the group to.
        :param str section_id: The ID of the section to add the group to.
        :rtype: :class:`<Group> <azure.devops.v6_0.work_item_tracking_process.models.Group>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def get_form_layout(self, process_id, wit_ref_name):
        ...
        :param str process_id: The ID of the process.
        :param str wit_ref_name: The reference name of the work item type.
        :rtype: :class:`<FormLayout> <azure.devops.v6_0.work_item_tracking_process.models.FormLayout>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def create_list(self, picklist):
        ...
        :param :class:`<PickList> <azure.devops.v6_0.work_item_tracking_process.models.PickList>` picklist: Picklist
        :rtype: :class:`<PickList> <azure.devops.v6_0.work_item_tracking_process.models.PickList>`
        """
    ...
    def update_list(self, picklist, list_id):
        ...
        :param :class:`<PickList> <azure.devops.v6_0.work_item_tracking_process.models.PickList>` picklist:
        :param str list_id: The ID of the list
        :rtype: :class:`<PickList> <azure.devops.v6_0.work_item_tracking_process.models.PickList>`
        """
        route_values = {}
    ...
    def add_page(self, page, process_id, wit_ref_name):
        ...
        :param :class:`<Page> <azure.devops.v6_0.work_item_tracking_process.models.Page>` page: The page.
        :param str process_id: The ID of the process.
        :param str wit_ref_name: The reference name of the work item type.
        :rtype: :class:`<Page> <azure.devops.v6_0.work_item_tracking_process.models.Page>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def create_new_process(self, create_request):
        ...
        :param :class:`<CreateProcessModel> <azure.devops.v6_0.work_item_tracking_process.models.CreateProcessModel>` create_request: CreateProcessModel.
        :rtype: :class:`<ProcessInfo> <azure.devops.v6_0.work_item_tracking_process.models.ProcessInfo>`
        """
    ...
    def edit_process(self, update_request, process_type_id):
        ...
        :param :class:`<UpdateProcessModel> <azure.devops.v6_0.work_item_tracking_process.models.UpdateProcessModel>` update_request:
        :param str process_type_id:
        :rtype: :class:`<ProcessInfo> <azure.devops.v6_0.work_item_tracking_process.models.ProcessInfo>`
        """
        route_values = {}
    ...
    def add_process_work_item_type_rule(self, process_rule_create, process_id, wit_ref_name):
        ...
        :param :class:`<CreateProcessRuleRequest> <azure.devops.v6_0.work_item_tracking_process.models.CreateProcessRuleRequest>` process_rule_create:
        :param str process_id: The ID of the process
        :param str wit_ref_name: The reference name of the work item type
        :rtype: :class:`<ProcessRule> <azure.devops.v6_0.work_item_tracking_process.models.ProcessRule>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def update_process_work_item_type_rule(self, process_rule, process_id, wit_ref_name, rule_id):
        ...
        :param :class:`<UpdateProcessRuleRequest> <azure.devops.v6_0.work_item_tracking_process.models.UpdateProcessRuleRequest>` process_rule:
        :param str process_id: The ID of the process
        :param str wit_ref_name: The reference name of the work item type
        :param str rule_id: The ID of the rule
        :rtype: :class:`<ProcessRule> <azure.devops.v6_0.work_item_tracking_process.models.ProcessRule>`
    ...
    def create_state_definition(self, state_model, process_id, wit_ref_name):
        ...
        :param :class:`<WorkItemStateInputModel> <azure.devops.v6_0.work_item_tracking_process.models.WorkItemStateInputModel>` state_model:
        :param str process_id: The ID of the process
        :param str wit_ref_name: The reference name of the work item type
        :rtype: :class:`<WorkItemStateResultModel> <azure.devops.v6_0.work_item_tracking_process.models.WorkItemStateResultModel>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def hide_state_definition(self, hide_state_model, process_id, wit_ref_name, state_id):
        ...
        :param :class:`<HideStateModel> <azure.devops.v6_0.work_item_tracking_process.models.HideStateModel>` hide_state_model:
        :param str process_id: The ID of the process
        :param str wit_ref_name: The reference name of the work item type
        :param str state_id: The ID of the state
        :rtype: :class:`<WorkItemStateResultModel> <azure.devops.v6_0.work_item_tracking_process.models.WorkItemStateResultModel>`
    ...
    def update_system_control(self, control, process_id, wit_ref_name, control_id):
        ...
        :param :class:`<Control> <azure.devops.v6_0.work_item_tracking_process.models.Control>` control:
        :param str process_id: The ID of the process.
        :param str wit_ref_name: The reference name of the work item type.
        :param str control_id: The ID of the control.
        :rtype: :class:`<Control> <azure.devops.v6_0.work_item_tracking_process.models.Control>`
    ...
    def create_process_work_item_type(self, work_item_type, process_id):
        ...
        :param :class:`<CreateProcessWorkItemTypeRequest> <azure.devops.v6_0.work_item_tracking_process.models.CreateProcessWorkItemTypeRequest>` work_item_type:
        :param str process_id: The ID of the process on which to create work item type.
        :rtype: :class:`<ProcessWorkItemType> <azure.devops.v6_0.work_item_tracking_process.models.ProcessWorkItemType>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def update_process_work_item_type(self, work_item_type_update, process_id, wit_ref_name):
        ...
        :param :class:`<UpdateProcessWorkItemTypeRequest> <azure.devops.v6_0.work_item_tracking_process.models.UpdateProcessWorkItemTypeRequest>` work_item_type_update:
        :param str process_id: The ID of the process
        :param str wit_ref_name: The reference name of the work item type
        :rtype: :class:`<ProcessWorkItemType> <azure.devops.v6_0.work_item_tracking_process.models.ProcessWorkItemType>`
        """
    ...
    def add_behavior_to_work_item_type(self, behavior, process_id, wit_ref_name_for_behaviors):
        ...
        :param :class:`<WorkItemTypeBehavior> <azure.devops.v6_0.work_item_tracking_process.models.WorkItemTypeBehavior>` behavior:
        :param str process_id: The ID of the process
        :param str wit_ref_name_for_behaviors: Work item type reference name for the behavior
        :rtype: :class:`<WorkItemTypeBehavior> <azure.devops.v6_0.work_item_tracking_process.models.WorkItemTypeBehavior>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
