...
class ProjectActivityMetrics(Model):
    ...
    :type code_changes_trend: list of :class:`CodeChangeTrendItem <azure.devops.v6_0.project_analysis.models.CodeChangeTrendItem>`
    :param project_id:
    :type project_id: str
...
class ProjectLanguageAnalytics(LanguageMetricsSecuredObject):
    ...
    :type language_breakdown: list of :class:`LanguageStatistics <azure.devops.v6_0.project_analysis.models.LanguageStatistics>`
    :param repository_language_analytics:
    :type repository_language_analytics: list of :class:`RepositoryLanguageAnalytics <azure.devops.v6_0.project_analysis.models.RepositoryLanguageAnalytics>`
    :param result_phase:
