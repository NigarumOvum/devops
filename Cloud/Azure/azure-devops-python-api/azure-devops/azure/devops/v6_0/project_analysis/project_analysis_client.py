...
class ProjectAnalysisClient(Client):
    ...
    def get_project_language_analytics(self, project):
        ...
        :rtype: :class:`<ProjectLanguageAnalytics> <azure.devops.v6_0.project_analysis.models.ProjectLanguageAnalytics>`
        """
        route_values = {}
    ...
    def get_project_activity_metrics(self, project, from_date, aggregation_type):
        ...
        :rtype: :class:`<ProjectActivityMetrics> <azure.devops.v6_0.project_analysis.models.ProjectActivityMetrics>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_repository_activity_metrics(self, project, repository_id, from_date, aggregation_type):
        ...
        :param datetime from_date:
        :param str aggregation_type:
        :rtype: :class:`<RepositoryActivityMetrics> <azure.devops.v6_0.project_analysis.models.RepositoryActivityMetrics>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
