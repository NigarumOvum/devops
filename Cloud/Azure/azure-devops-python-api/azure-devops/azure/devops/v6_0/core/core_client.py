...
class CoreClient(Client):
    ...
    def set_project_avatar(self, avatar_blob, project_id):
        ...
        :param :class:`<ProjectAvatar> <azure.devops.v6_0.core.models.ProjectAvatar>` avatar_blob: The avatar blob data object to upload.
        :param str project_id: The ID or name of the project.
        """
        route_values = {}
        if project_id is not None:
    ...
    def create_connected_service(self, connected_service_creation_data, project_id):
        ...
        [Preview API]
        :param :class:`<WebApiConnectedServiceDetails> <azure.devops.v6_0.core.models.WebApiConnectedServiceDetails>` connected_service_creation_data:
        :param str project_id:
        :rtype: :class:`<WebApiConnectedService> <azure.devops.v6_0.core.models.WebApiConnectedService>`
        """
        route_values = {}
        if project_id is not None:
            route_values['projectId'] = self._serialize.url('project_id', project_id, 'str')
    ...
    def get_connected_service_details(self, project_id, name):
        ...
        :param str project_id:
        :param str name:
        :rtype: :class:`<WebApiConnectedServiceDetails> <azure.devops.v6_0.core.models.WebApiConnectedServiceDetails>`
        """
        route_values = {}
        if project_id is not None:
            route_values['projectId'] = self._serialize.url('project_id', project_id, 'str')
    ...
    def set_project_properties(self, project_id, patch_document):
        ...
        :param str project_id: The team project ID.
        :param :class:`<[JsonPatchOperation]> <azure.devops.v6_0.core.models.[JsonPatchOperation]>` patch_document: A JSON Patch document that represents an array of property operations. See RFC 6902 for more details on JSON Patch. The accepted operation verbs are Add and Remove, where Add is used for both creating and updating properties. The path consists of a forward slash and a property name.
        """
        route_values = {}
        if project_id is not None:
            route_values['projectId'] = self._serialize.url('project_id', project_id, 'str')
    ...
    def create_or_update_proxy(self, proxy):
        """CreateOrUpdateProxy.
        [Preview API]
        :param :class:`<Proxy> <azure.devops.v6_0.core.models.Proxy>` proxy:
        :rtype: :class:`<Proxy> <azure.devops.v6_0.core.models.Proxy>`
        """
