...
class AgentGroup(Model):
    ...
    :type machine_access_data: list of :class:`AgentGroupAccessData <azure.devops.v6_0.microsoft._visual_studio._test_service._web_api_model.models.AgentGroupAccessData>`
    :param machine_configuration: Machine configuration
    :type machine_configuration: :class:`WebApiUserLoadTestMachineInput <azure.devops.v6_0.microsoft._visual_studio._test_service._web_api_model.models.WebApiUserLoadTestMachineInput>`
...
class CounterInstanceSamples(Model):
    ...
    :param values:
    :type values: list of :class:`CounterSample <azure.devops.v6_0.microsoft._visual_studio._test_service._web_api_model.models.CounterSample>`
    """
...
class CounterSamplesResult(Model):
    ...
    :type values: list of :class:`CounterInstanceSamples <azure.devops.v6_0.microsoft._visual_studio._test_service._web_api_model.models.CounterInstanceSamples>`
    """
...
class GraphSubjectBase(Model):
    """
    :param _links:
    :type _links: :class:`ReferenceLinks <azure.devops.v6_0.microsoft._visual_studio._test_service._web_api_model.models.ReferenceLinks>`
    :param descriptor:
    :type descriptor: str
    :param display_name:
...
class LoadTestDefinition(Model):
    ...
    :param browser_mixs:
    :type browser_mixs: list of :class:`BrowserMix <azure.devops.v6_0.microsoft._visual_studio._test_service._web_api_model.models.BrowserMix>`
    :param core_count:
    :type core_count: int
...
class LoadTestErrors(Model):
    ...
    :type occurrences: int
    :param types:
    :type types: list of :class:`object <azure.devops.v6_0.microsoft._visual_studio._test_service._web_api_model.models.object>`
    :param url:
    :type url: str
    """
