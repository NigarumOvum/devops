...
class Package(Model):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v6_0.upack.models.ReferenceLinks>`
...
class PackageVersionDetails(Model):
    ...
    :type views: :class:`JsonPatchOperation <azure.devops.v6_0.upack.models.JsonPatchOperation>`
    """
...
class UPackPackagesBatchRequest(Model):
    ...
    :type data: :class:`BatchOperationData <azure.devops.v6_0.upack.models.BatchOperationData>`
    ...
    :type packages: list of :class:`MinimalPackageDetails <azure.devops.v6_0.upack.models.MinimalPackageDetails>`
    """
