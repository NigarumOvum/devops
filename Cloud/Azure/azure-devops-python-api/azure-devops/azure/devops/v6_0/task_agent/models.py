...
class AzureManagementGroupQueryResult(Model):
    ...
    :type value: list of :class:`AzureManagementGroup <azure.devops.v6_0.task_agent.models.AzureManagementGroup>`
    """
...
class AzureSubscriptionQueryResult(Model):
    ...
    :type error_message: str
    :param value:
    :type value: list of :class:`AzureSubscription <azure.devops.v6_0.task_agent.models.AzureSubscription>`
    """
...
class DataSource(Model):
    ...
    :type authentication_scheme: :class:`AuthenticationSchemeReference <azure.devops.v6_0.task_agent.models.AuthenticationSchemeReference>`
    :param endpoint_url:
    :type endpoint_url: str
    :param headers:
    :type headers: list of :class:`AuthorizationHeader <azure.devops.v6_0.task_agent.models.AuthorizationHeader>`
    :param name:
    :type name: str
    :param resource_url:
...
class DependsOn(Model):
    ...
    :type input: str
    :param map:
    :type map: list of :class:`DependencyBinding <azure.devops.v6_0.task_agent.models.DependencyBinding>`
    """
...
class DeploymentGroupCreateParameter(Model):
    ...
    :type pool: :class:`DeploymentGroupCreateParameterPoolProperty <azure.devops.v6_0.task_agent.models.DeploymentGroupCreateParameterPoolProperty>`
...
class DeploymentGroupMetrics(Model):
    ...
    :type columns_header: :class:`MetricsColumnsHeader <azure.devops.v6_0.task_agent.models.MetricsColumnsHeader>`
    :param deployment_group: Deployment group.
    :type deployment_group: :class:`DeploymentGroupReference <azure.devops.v6_0.task_agent.models.DeploymentGroupReference>`
    ...
    :type rows: list of :class:`MetricsRow <azure.devops.v6_0.task_agent.models.MetricsRow>`
    """
...
class DeploymentGroupReference(Model):
    ...
    :type pool: :class:`TaskAgentPoolReference <azure.devops.v6_0.task_agent.models.TaskAgentPoolReference>`
    :param project: Project to which the deployment group belongs.
    :type project: :class:`ProjectReference <azure.devops.v6_0.task_agent.models.ProjectReference>`
    """
...
class DeploymentMachine(Model):
    ...
    :type agent: :class:`TaskAgent <azure.devops.v6_0.task_agent.models.TaskAgent>`
    :param id: Deployment target Identifier.
    :type id: int
    :param properties: Properties of the deployment target.
    :type properties: :class:`object <azure.devops.v6_0.task_agent.models.object>`
...
class DeploymentPoolSummary(Model):
    ...
    :type deployment_groups: list of :class:`DeploymentGroupReference <azure.devops.v6_0.task_agent.models.DeploymentGroupReference>`
    ...
    :type resource: :class:`EnvironmentResourceReference <azure.devops.v6_0.task_agent.models.EnvironmentResourceReference>`
    """
...
class EndpointUrl(Model):
    ...
    :type depends_on: :class:`DependsOn <azure.devops.v6_0.task_agent.models.DependsOn>`
...
class EnvironmentDeploymentExecutionRecord(Model):
    ...
    :type definition: :class:`TaskOrchestrationOwner <azure.devops.v6_0.task_agent.models.TaskOrchestrationOwner>`
    ...
    :type owner: :class:`TaskOrchestrationOwner <azure.devops.v6_0.task_agent.models.TaskOrchestrationOwner>`
...
class EnvironmentInstance(Model):
    ...
    :type last_modified_by: :class:`IdentityRef <azure.devops.v6_0.task_agent.models.IdentityRef>`
    :param last_modified_on: Last modified time of the Environment
    :type last_modified_on: datetime
    :param name: Name of the Environment.
    :type name: str
    :param project: Project information for environment.
    :type project: :class:`ProjectReference <azure.devops.v6_0.task_agent.models.ProjectReference>`
    :param resources:
    :type resources: list of :class:`EnvironmentResourceReference <azure.devops.v6_0.task_agent.models.EnvironmentResourceReference>`
    """
    ...
    def __init__(self, created_by=None, created_on=None, description=None, id=None, last_modified_by=None, last_modified_on=None, name=None, project=None, resources=None):
...
class EnvironmentResource(Model):
    ...
    :type environment_reference: :class:`EnvironmentReference <azure.devops.v6_0.task_agent.models.EnvironmentReference>`
    :param id:
    :type id: int
    ...
    :param name:
    :type name: str
    :param tags: Tags of the Environment Resource.
    :type tags: list of str
    ...
    def __init__(self, created_by=None, created_on=None, environment_reference=None, id=None, last_modified_by=None, last_modified_on=None, name=None, tags=None, type=None):
...
class EnvironmentResourceReference(Model):
    ...
    :type name: str
    :param tags: Tags of the Environment Resource Reference.
    :type tags: list of str
    ...
    def __init__(self, id=None, name=None, tags=None, type=None):
...
class KubernetesResource(EnvironmentResource):
    ...
    def __init__(self, created_by=None, created_on=None, environment_reference=None, id=None, last_modified_by=None, last_modified_on=None, name=None, tags=None, type=None, cluster_name=None, namespace=None, service_endpoint_id=None):
        super(KubernetesResource, self).__init__(created_by=created_by, created_on=created_on, environment_reference=environment_reference, id=id, last_modified_by=last_modified_by, last_modified_on=last_modified_on, name=name, tags=tags, type=type)
...
class KubernetesResourceCreateParameters(Model):
    ...
    :param namespace:
    :type namespace: str
    :param tags: Tags of the kubernetes resource.
    :type tags: list of str
    """
    ...
    def __init__(self, cluster_name=None, name=None, namespace=None, tags=None):
...
class MetricsColumnsHeader(Model):
    ...
    :type dimensions: list of :class:`MetricsColumnMetaData <azure.devops.v6_0.task_agent.models.MetricsColumnMetaData>`
    ...
    :type metrics: list of :class:`MetricsColumnMetaData <azure.devops.v6_0.task_agent.models.MetricsColumnMetaData>`
    """
...
class PackageMetadata(Model):
    ...
    :type version: :class:`PackageVersion <azure.devops.v6_0.task_agent.models.PackageVersion>`
    """
...
class ResourceUsage(Model):
    ...
    :type resource_limit: :class:`ResourceLimit <azure.devops.v6_0.task_agent.models.ResourceLimit>`
    :param running_requests:
    :type running_requests: list of :class:`TaskAgentJobRequest <azure.devops.v6_0.task_agent.models.TaskAgentJobRequest>`
    :param used_count:
    :type used_count: int
    :param used_minutes:
...
class SecureFile(Model):
    ...
    :type id: str
    :param modified_by:
    :type modified_by: :class:`IdentityRef <azure.devops.v6_0.task_agent.models.IdentityRef>`
    :param modified_on:
...
class ServiceEndpoint(Model):
    ...
    :type administrators_group: :class:`IdentityRef <azure.devops.v6_0.task_agent.models.IdentityRef>`
    :param authorization: Gets or sets the authorization data for talking to the endpoint.
    :type authorization: :class:`EndpointAuthorization <azure.devops.v6_0.task_agent.models.EndpointAuthorization>`
    ...
    :type operation_status: :class:`object <azure.devops.v6_0.task_agent.models.object>`
    ...
    :type readers_group: :class:`IdentityRef <azure.devops.v6_0.task_agent.models.IdentityRef>`
...
class ServiceEndpointAuthenticationScheme(Model):
    ...
    :type authorization_headers: list of :class:`AuthorizationHeader <azure.devops.v6_0.task_agent.models.AuthorizationHeader>`
    :param client_certificates: Gets or sets the certificates of service endpoint authentication scheme.
    :type client_certificates: list of :class:`ClientCertificate <azure.devops.v6_0.task_agent.models.ClientCertificate>`
    ...
    :type input_descriptors: list of :class:`InputDescriptor <azure.devops.v6_0.task_agent.models.InputDescriptor>`
...
class ServiceEndpointExecutionRecord(Model):
    ...
    :type data: :class:`ServiceEndpointExecutionData <azure.devops.v6_0.task_agent.models.ServiceEndpointExecutionData>`
...
class ServiceEndpointRequest(Model):
    ...
    :type data_source_details: :class:`DataSourceDetails <azure.devops.v6_0.task_agent.models.DataSourceDetails>`
    :param result_transformation_details:
    :type result_transformation_details: :class:`ResultTransformationDetails <azure.devops.v6_0.task_agent.models.ResultTransformationDetails>`
    :param service_endpoint_details:
    :type service_endpoint_details: :class:`ServiceEndpointDetails <azure.devops.v6_0.task_agent.models.ServiceEndpointDetails>`
    """
...
class ServiceEndpointRequestResult(Model):
    ...
    :type error_message: str
    :param result:
    :type result: :class:`object <azure.devops.v6_0.task_agent.models.object>`
    :param status_code:
...
class ServiceEndpointType(Model):
    ...
    :type authentication_schemes: list of :class:`ServiceEndpointAuthenticationScheme <azure.devops.v6_0.task_agent.models.ServiceEndpointAuthenticationScheme>`
    :param data_sources: Data sources of service endpoint type.
    :type data_sources: list of :class:`DataSource <azure.devops.v6_0.task_agent.models.DataSource>`
    :param dependency_data: Dependency data of service endpoint type.
    :type dependency_data: list of :class:`DependencyData <azure.devops.v6_0.task_agent.models.DependencyData>`
    ...
    :type endpoint_url: :class:`EndpointUrl <azure.devops.v6_0.task_agent.models.EndpointUrl>`
    :param help_link: Gets or sets the help link of service endpoint type.
    :type help_link: :class:`HelpLink <azure.devops.v6_0.task_agent.models.HelpLink>`
...
class TaskAgentAuthorization(Model):
    ...
    :type public_key: :class:`TaskAgentPublicKey <azure.devops.v6_0.task_agent.models.TaskAgentPublicKey>`
    """
...
class TaskAgentCloudRequest(Model):
    """
    :param agent:
    :type agent: :class:`TaskAgentReference <azure.devops.v6_0.task_agent.models.TaskAgentReference>`
    :param agent_cloud_id:
    :type agent_cloud_id: int
    :param agent_connected_time:
    :type agent_connected_time: datetime
    :param agent_data:
    :type agent_data: :class:`object <azure.devops.v6_0.task_agent.models.object>`
    :param agent_specification:
    :type agent_specification: :class:`object <azure.devops.v6_0.task_agent.models.object>`
    :param pool:
    :type pool: :class:`TaskAgentPoolReference <azure.devops.v6_0.task_agent.models.TaskAgentPoolReference>`
...
class TaskAgentDelaySource(Model):
    ...
    :param task_agent:
    :type task_agent: :class:`TaskAgentReference <azure.devops.v6_0.task_agent.models.TaskAgentReference>`
    """
...
class TaskAgentJobRequest(Model):
    ...
    :param agent_delays:
    :type agent_delays: list of :class:`TaskAgentDelaySource <azure.devops.v6_0.task_agent.models.TaskAgentDelaySource>`
    :param agent_specification:
    :type agent_specification: :class:`object <azure.devops.v6_0.task_agent.models.object>`
    ...
    :type demands: list of :class:`object <azure.devops.v6_0.task_agent.models.object>`
    ...
    :type matched_agents: list of :class:`TaskAgentReference <azure.devops.v6_0.task_agent.models.TaskAgentReference>`
    ...
    :type reserved_agent: :class:`TaskAgentReference <azure.devops.v6_0.task_agent.models.TaskAgentReference>`
...
class TaskAgentPoolMaintenanceDefinition(Model):
    ...
    :param options:
    :type options: :class:`TaskAgentPoolMaintenanceOptions <azure.devops.v6_0.task_agent.models.TaskAgentPoolMaintenanceOptions>`
    :param pool: Pool reference for the maintenance definition
    :type pool: :class:`TaskAgentPoolReference <azure.devops.v6_0.task_agent.models.TaskAgentPoolReference>`
    :param retention_policy:
    :type retention_policy: :class:`TaskAgentPoolMaintenanceRetentionPolicy <azure.devops.v6_0.task_agent.models.TaskAgentPoolMaintenanceRetentionPolicy>`
    :param schedule_setting:
    :type schedule_setting: :class:`TaskAgentPoolMaintenanceSchedule <azure.devops.v6_0.task_agent.models.TaskAgentPoolMaintenanceSchedule>`
    """
...
class TaskAgentPoolMaintenanceJob(Model):
    ...
    :type requested_by: :class:`IdentityRef <azure.devops.v6_0.task_agent.models.IdentityRef>`
    ...
    :type status: object
    :param target_agents:
    :type target_agents: list of :class:`TaskAgentPoolMaintenanceJobTargetAgent <azure.devops.v6_0.task_agent.models.TaskAgentPoolMaintenanceJobTargetAgent>`
...
class TaskAgentReference(Model):
    ...
    :param _links:
    :type _links: :class:`ReferenceLinks <azure.devops.v6_0.task_agent.models.ReferenceLinks>`
...
class TaskAgentSession(Model):
    ...
    :type encryption_key: :class:`TaskAgentSessionKey <azure.devops.v6_0.task_agent.models.TaskAgentSessionKey>`
...
class TaskAgentUpdate(Model):
    ...
    :type reason: :class:`TaskAgentUpdateReason <azure.devops.v6_0.task_agent.models.TaskAgentUpdateReason>`
    ...
    :type source_version: :class:`PackageVersion <azure.devops.v6_0.task_agent.models.PackageVersion>`
    :param target_version: Target agent version of the update.
    :type target_version: :class:`PackageVersion <azure.devops.v6_0.task_agent.models.PackageVersion>`
    """
...
class TaskDefinition(Model):
    ...
    :type agent_execution: :class:`TaskExecution <azure.devops.v6_0.task_agent.models.TaskExecution>`
    :param author:
    :type author: str
    :param category:
    :type category: str
    ...
    :type data_source_bindings: list of :class:`DataSourceBinding <azure.devops.v6_0.task_agent.models.DataSourceBinding>`
    ...
    :param groups:
    :type groups: list of :class:`TaskGroupDefinition <azure.devops.v6_0.task_agent.models.TaskGroupDefinition>`
    :param help_mark_down:
    :type help_mark_down: str
    :param help_url:
    :type help_url: str
    ...
    :type id: str
    :param inputs:
    :type inputs: list of :class:`TaskInputDefinition <azure.devops.v6_0.task_agent.models.TaskInputDefinition>`
    ...
    :type output_variables: list of :class:`TaskOutputVariable <azure.devops.v6_0.task_agent.models.TaskOutputVariable>`
    ...
    :type source_definitions: list of :class:`TaskSourceDefinition <azure.devops.v6_0.task_agent.models.TaskSourceDefinition>`
    :param source_location:
    :type source_location: str
    :param version:
    :type version: :class:`TaskVersion <azure.devops.v6_0.task_agent.models.TaskVersion>`
    :param visibility:
...
class TaskExecution(Model):
    ...
    :type exec_task: :class:`TaskReference <azure.devops.v6_0.task_agent.models.TaskReference>`
...
class TaskGroup(TaskDefinition):
    ...
    :type tasks: list of :class:`TaskGroupStep <azure.devops.v6_0.task_agent.models.TaskGroupStep>`
    """
...
class TaskGroupRevision(Model):
    """
    :param changed_by:
    :type changed_by: :class:`IdentityRef <azure.devops.v6_0.task_agent.models.IdentityRef>`
    :param changed_date:
...
class TaskGroupStep(Model):
    ...
    :type task: :class:`TaskDefinitionReference <azure.devops.v6_0.task_agent.models.TaskDefinitionReference>`
...
class TaskGroupUpdatePropertiesBase(Model):
    """
    :param comment: Comment for this update request
    :type comment: str
    """
    ...
    def __init__(self, comment=None):
        super(TaskGroupUpdatePropertiesBase, self).__init__()
        self.comment = comment
...
class VariableGroup(Model):
    ...
    :type provider_data: :class:`VariableGroupProviderData <azure.devops.v6_0.task_agent.models.VariableGroupProviderData>`
    ...
    :type variable_group_project_references: list of :class:`VariableGroupProjectReference <azure.devops.v6_0.task_agent.models.VariableGroupProjectReference>`
...
class VariableGroupParameters(Model):
    ...
    :type type: str
    :param variable_group_project_references:
    :type variable_group_project_references: list of :class:`VariableGroupProjectReference <azure.devops.v6_0.task_agent.models.VariableGroupProjectReference>`
    ...
    def __init__(self, description=None, name=None, provider_data=None, type=None, variable_group_project_references=None, variables=None):
...
class VariableGroupProjectReference(Model):
    ...
    :type project_reference: :class:`ProjectReference <azure.devops.v6_0.task_agent.models.ProjectReference>`
    """
...
class VirtualMachineGroup(EnvironmentResource):
    ...
    def __init__(self, created_by=None, created_on=None, environment_reference=None, id=None, last_modified_by=None, last_modified_on=None, name=None, tags=None, type=None, pool_id=None):
        super(VirtualMachineGroup, self).__init__(created_by=created_by, created_on=created_on, environment_reference=environment_reference, id=id, last_modified_by=last_modified_by, last_modified_on=last_modified_on, name=name, tags=tags, type=type)
        self.pool_id = pool_id
...
class DeploymentGroup(DeploymentGroupReference):
    ...
    :type machines: list of :class:`DeploymentMachine <azure.devops.v6_0.task_agent.models.DeploymentMachine>`
...
class TaskAgent(TaskAgentReference):
    ...
    :type assigned_agent_cloud_request: :class:`TaskAgentCloudRequest <azure.devops.v6_0.task_agent.models.TaskAgentCloudRequest>`
    :param assigned_request: The request which is currently assigned to this agent.
    :type assigned_request: :class:`TaskAgentJobRequest <azure.devops.v6_0.task_agent.models.TaskAgentJobRequest>`
    :param authorization: Authorization information for this agent.
    :type authorization: :class:`TaskAgentAuthorization <azure.devops.v6_0.task_agent.models.TaskAgentAuthorization>`
    ...
    :type last_completed_request: :class:`TaskAgentJobRequest <azure.devops.v6_0.task_agent.models.TaskAgentJobRequest>`
    :param max_parallelism: Maximum job parallelism allowed for this agent.
    :type max_parallelism: int
    :param pending_update: Pending update for this agent.
    :type pending_update: :class:`TaskAgentUpdate <azure.devops.v6_0.task_agent.models.TaskAgentUpdate>`
    :param properties:
    :type properties: :class:`object <azure.devops.v6_0.task_agent.models.object>`
...
class TaskAgentPool(TaskAgentPoolReference):
    ...
    :type owner: :class:`IdentityRef <azure.devops.v6_0.task_agent.models.IdentityRef>`
    :param properties:
    :type properties: :class:`object <azure.devops.v6_0.task_agent.models.object>`
...
class TaskInputDefinition(TaskInputDefinitionBase):
    ...
    :type type: str
    :param validation:
    :type validation: :class:`TaskInputValidation <azure.devops.v6_0.task_agent.models.TaskInputValidation>`
    :param visible_rule:
    :type visible_rule: str
    """
