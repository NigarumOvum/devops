...
class ClientContribution(Model):
    ...
    :type properties: :class:`object <azure.devops.v6_0.contributions.models.object>`
...
class ClientContributionNode(Model):
    ...
    :type contribution: :class:`ClientContribution <azure.devops.v6_0.contributions.models.ClientContribution>`
...
class ContributionNodeQuery(Model):
    ...
    :type data_provider_context: :class:`DataProviderContext <azure.devops.v6_0.contributions.models.DataProviderContext>`
...
class DataProviderQuery(Model):
    ...
    :type context: :class:`DataProviderContext <azure.devops.v6_0.contributions.models.DataProviderContext>`
...
class DataProviderResult(Model):
    ...
    :type resolved_providers: list of :class:`ResolvedDataProvider <azure.devops.v6_0.contributions.models.ResolvedDataProvider>`
...
class ExtensionEventCallbackCollection(Model):
    ...
    :type post_disable: :class:`ExtensionEventCallback <azure.devops.v6_0.contributions.models.ExtensionEventCallback>`
    ...
    :type post_enable: :class:`ExtensionEventCallback <azure.devops.v6_0.contributions.models.ExtensionEventCallback>`
    ...
    :type post_install: :class:`ExtensionEventCallback <azure.devops.v6_0.contributions.models.ExtensionEventCallback>`
    ...
    :type post_uninstall: :class:`ExtensionEventCallback <azure.devops.v6_0.contributions.models.ExtensionEventCallback>`
    ...
    :type post_update: :class:`ExtensionEventCallback <azure.devops.v6_0.contributions.models.ExtensionEventCallback>`
    ...
    :type pre_install: :class:`ExtensionEventCallback <azure.devops.v6_0.contributions.models.ExtensionEventCallback>`
    ...
    :type version_check: :class:`ExtensionEventCallback <azure.devops.v6_0.contributions.models.ExtensionEventCallback>`
    """
...
class ExtensionLicensing(Model):
    ...
    :type overrides: list of :class:`LicensingOverride <azure.devops.v6_0.contributions.models.LicensingOverride>`
    """
...
class ExtensionManifest(Model):
    ...
    :type constraints: list of :class:`ContributionConstraint <azure.devops.v6_0.contributions.models.ContributionConstraint>`
    :param contributions: List of contributions made by this extension
    :type contributions: list of :class:`Contribution <azure.devops.v6_0.contributions.models.Contribution>`
    :param contribution_types: List of contribution types defined by this extension
    :type contribution_types: list of :class:`ContributionType <azure.devops.v6_0.contributions.models.ContributionType>`
    ...
    :type event_callbacks: :class:`ExtensionEventCallbackCollection <azure.devops.v6_0.contributions.models.ExtensionEventCallbackCollection>`
    ...
    :type licensing: :class:`ExtensionLicensing <azure.devops.v6_0.contributions.models.ExtensionLicensing>`
...
class InstalledExtension(ExtensionManifest):
    ...
    :type files: list of :class:`ExtensionFile <azure.devops.v6_0.contributions.models.ExtensionFile>`
    ...
    :type install_state: :class:`InstalledExtensionState <azure.devops.v6_0.contributions.models.InstalledExtensionState>`
...
class InstalledExtensionState(Model):
    ...
    :type installation_issues: list of :class:`InstalledExtensionStateIssue <azure.devops.v6_0.contributions.models.InstalledExtensionStateIssue>`
