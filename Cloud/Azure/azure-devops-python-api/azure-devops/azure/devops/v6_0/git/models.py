...
class GitPolicyConfigurationResponse(Model):
    ...
    :type policy_configurations: list of :class:`PolicyConfiguration <azure.devops.v6_0.git.models.PolicyConfiguration>`
    """
...
class GitPullRequest(Model):
    ...
    :type auto_complete_set_by: :class:`IdentityRef <azure.devops.v6_0.git.models.IdentityRef>`
    :param closed_by: The user who closed the pull request.
    :type closed_by: :class:`IdentityRef <azure.devops.v6_0.git.models.IdentityRef>`
    ...
    :type completion_options: :class:`GitPullRequestCompletionOptions <azure.devops.v6_0.git.models.GitPullRequestCompletionOptions>`
    ...
    :type fork_source: :class:`GitForkRef <azure.devops.v6_0.git.models.GitForkRef>`
    :param is_draft: Draft / WIP pull request.
    :type is_draft: bool
    :param labels: The labels associated with the pull request.
    :type labels: list of :class:`WebApiTagDefinition <azure.devops.v6_0.git.models.WebApiTagDefinition>`
    ...
    :type last_merge_commit: :class:`GitCommitRef <azure.devops.v6_0.git.models.GitCommitRef>`
    :param last_merge_source_commit: The commit at the head of the source branch at the time of the last pull request merge.
    :type last_merge_source_commit: :class:`GitCommitRef <azure.devops.v6_0.git.models.GitCommitRef>`
    :param last_merge_target_commit: The commit at the head of the target branch at the time of the last pull request merge.
    :type last_merge_target_commit: :class:`GitCommitRef <azure.devops.v6_0.git.models.GitCommitRef>`
    ...
    :type merge_options: :class:`GitPullRequestMergeOptions <azure.devops.v6_0.git.models.GitPullRequestMergeOptions>`
    ...
    :type reviewers: list of :class:`IdentityRefWithVote <azure.devops.v6_0.git.models.IdentityRefWithVote>`
    ...
    :type work_item_refs: list of :class:`ResourceRef <azure.devops.v6_0.git.models.ResourceRef>`
    """
...
class GitPullRequestCommentThread(CommentThread):
    ...
    :type pull_request_thread_context: :class:`GitPullRequestCommentThreadContext <azure.devops.v6_0.git.models.GitPullRequestCommentThreadContext>`
    """
...
class GitPullRequestCommentThreadContext(Model):
    ...
    :type iteration_context: :class:`CommentIterationContext <azure.devops.v6_0.git.models.CommentIterationContext>`
    ...
    :type tracking_criteria: :class:`CommentTrackingCriteria <azure.devops.v6_0.git.models.CommentTrackingCriteria>`
    """
...
class GitPullRequestIteration(Model):
    ...
    :type change_list: list of :class:`GitPullRequestChange <azure.devops.v6_0.git.models.GitPullRequestChange>`
    ...
    :type common_ref_commit: :class:`GitCommitRef <azure.devops.v6_0.git.models.GitCommitRef>`
    ...
    :type source_ref_commit: :class:`GitCommitRef <azure.devops.v6_0.git.models.GitCommitRef>`
    :param target_ref_commit: The target Git commit of this iteration.
    :type target_ref_commit: :class:`GitCommitRef <azure.devops.v6_0.git.models.GitCommitRef>`
...
class GitPullRequestIterationChanges(Model):
    ...
    :type change_entries: list of :class:`GitPullRequestChange <azure.devops.v6_0.git.models.GitPullRequestChange>`
...
class GitPullRequestQuery(Model):
    ...
    :type queries: list of :class:`GitPullRequestQueryInput <azure.devops.v6_0.git.models.GitPullRequestQueryInput>`
...
class GitQueryBranchStatsCriteria(Model):
    """
    :param base_commit:
    :type base_commit: :class:`GitVersionDescriptor <azure.devops.v6_0.git.models.GitVersionDescriptor>`
    :param target_commits:
    :type target_commits: list of :class:`GitVersionDescriptor <azure.devops.v6_0.git.models.GitVersionDescriptor>`
    """
...
class GitQueryCommitsCriteria(Model):
    ...
    :type compare_version: :class:`GitVersionDescriptor <azure.devops.v6_0.git.models.GitVersionDescriptor>`
    ...
    :type item_version: :class:`GitVersionDescriptor <azure.devops.v6_0.git.models.GitVersionDescriptor>`
