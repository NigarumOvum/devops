...
class FeedBatchData(Model):
    """
    :param data:
    :type data: :class:`FeedBatchOperationData <azure.devops.v6_0.packaging.models.FeedBatchOperationData>`
    :param operation:
...
class FeedChange(Model):
    ...
    :type feed: :class:`Feed <azure.devops.v6_0.packaging.models.Feed>`
...
class FeedChangesResponse(Model):
    ...
    :param _links:
    :type _links: :class:`ReferenceLinks <azure.devops.v6_0.packaging.models.ReferenceLinks>`
    ...
    :type feed_changes: list of :class:`FeedChange <azure.devops.v6_0.packaging.models.FeedChange>`
...
class FeedCore(Model):
    ...
    :type upstream_sources: list of :class:`UpstreamSource <azure.devops.v6_0.packaging.models.UpstreamSource>`
    :param view: Definition of the view.
    :type view: :class:`FeedView <azure.devops.v6_0.packaging.models.FeedView>`
...
class FeedPermission(Model):
    ...
    :type identity_descriptor: :class:`str <azure.devops.v6_0.packaging.models.str>`
...
class MinimalPackageVersion(Model):
    ...
    :type views: list of :class:`FeedView <azure.devops.v6_0.packaging.models.FeedView>`
    """
...
class Package(Model):
    ...
    :type versions: list of :class:`MinimalPackageVersion <azure.devops.v6_0.packaging.models.MinimalPackageVersion>`
    """
...
class PackageChange(Model):
    ...
    :type package: :class:`Package <azure.devops.v6_0.packaging.models.Package>`
    :param package_version_change: Change that was performed on a package version.
    :type package_version_change: :class:`PackageVersionChange <azure.devops.v6_0.packaging.models.PackageVersionChange>`
    """
...
class PackageChangesResponse(Model):
    ...
    :type package_changes: list of :class:`PackageChange <azure.devops.v6_0.packaging.models.PackageChange>`
    """
...
class PackageFile(Model):
    ...
    :type children: list of :class:`PackageFile <azure.devops.v6_0.packaging.models.PackageFile>`
    :param name: File name.
    :type name: str
    :param protocol_metadata: Extended data unique to a specific package type.
    :type protocol_metadata: :class:`ProtocolMetadata <azure.devops.v6_0.packaging.models.ProtocolMetadata>`
    """
...
class PackageVersion(MinimalPackageVersion):
    ...
    :type dependencies: list of :class:`PackageDependency <azure.devops.v6_0.packaging.models.PackageDependency>`
    ...
    :type files: list of :class:`PackageFile <azure.devops.v6_0.packaging.models.PackageFile>`
    :param other_versions: Other versions of this package.
    :type other_versions: list of :class:`MinimalPackageVersion <azure.devops.v6_0.packaging.models.MinimalPackageVersion>`
    ...
    :type source_chain: list of :class:`UpstreamSource <azure.devops.v6_0.packaging.models.UpstreamSource>`
...
class PackageVersionChange(Model):
    ...
    :type package_version: :class:`PackageVersion <azure.devops.v6_0.packaging.models.PackageVersion>`
    """
...
class PackageVersionProvenance(Model):
    ...
    :type provenance: :class:`Provenance <azure.devops.v6_0.packaging.models.Provenance>`
    """
...
class UpstreamSource(Model):
    ...
    :type status_details: list of :class:`UpstreamStatusDetail <azure.devops.v6_0.packaging.models.UpstreamStatusDetail>`
    ...
    def __init__(self, deleted_date=None, display_location=None, id=None, internal_upstream_collection_id=None, internal_upstream_feed_id=None, internal_upstream_project_id=None, internal_upstream_view_id=None, location=None, name=None, protocol=None, status=None, status_details=None, upstream_source_type=None):
...
class Feed(FeedCore):
    ...
    :type permissions: list of :class:`FeedPermission <azure.devops.v6_0.packaging.models.FeedPermission>`
