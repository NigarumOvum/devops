...
class NuGetPackagesBatchRequest(Model):
    ...
    :type data: :class:`BatchOperationData <azure.devops.v6_0.nuget.models.BatchOperationData>`
    ...
    :type packages: list of :class:`MinimalPackageDetails <azure.devops.v6_0.nuget.models.MinimalPackageDetails>`
    """
...
class Package(Model):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v6_0.nuget.models.ReferenceLinks>`
    ...
    :type source_chain: list of :class:`UpstreamSourceInfo <azure.devops.v6_0.nuget.models.UpstreamSourceInfo>`
...
class PackageVersionDetails(Model):
    ...
    :type views: :class:`JsonPatchOperation <azure.devops.v6_0.nuget.models.JsonPatchOperation>`
    """
