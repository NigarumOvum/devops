...
class TestPlanClient(Client):
    ...
    def create_test_configuration(self, test_configuration_create_update_parameters, project):
        ...
        :param :class:`<TestConfigurationCreateUpdateParameters> <azure.devops.v6_0.test_plan.models.TestConfigurationCreateUpdateParameters>` test_configuration_create_update_parameters: TestConfigurationCreateUpdateParameters
        :param str project: Project ID or project name
        :rtype: :class:`<TestConfiguration> <azure.devops.v6_0.test_plan.models.TestConfiguration>`
        """
        route_values = {}
    ...
    def create_test_plan(self, test_plan_create_params, project):
        ...
        :param :class:`<TestPlanCreateParams> <azure.devops.v6_0.test_plan.models.TestPlanCreateParams>` test_plan_create_params: A testPlanCreateParams object.TestPlanCreateParams
        :param str project: Project ID or project name
        :rtype: :class:`<TestPlan> <azure.devops.v6_0.test_plan.models.TestPlan>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_test_plan(self, test_plan_update_params, project, plan_id):
        ...
        :param :class:`<TestPlanUpdateParams> <azure.devops.v6_0.test_plan.models.TestPlanUpdateParams>` test_plan_update_params: A testPlanUpdateParams object.TestPlanUpdateParams
        :param str project: Project ID or project name
    ...
    def create_test_suite(self, test_suite_create_params, project, plan_id):
        ...
        :param :class:`<TestSuiteCreateParams> <azure.devops.v6_0.test_plan.models.TestSuiteCreateParams>` test_suite_create_params: Parameters for suite creation
        :param str project: Project ID or project name
    ...
    def update_test_suite(self, test_suite_update_params, project, plan_id, suite_id):
        ...
        :param :class:`<TestSuiteUpdateParams> <azure.devops.v6_0.test_plan.models.TestSuiteUpdateParams>` test_suite_update_params: Parameters for suite updation
        :param str project: Project ID or project name
        :param int plan_id: ID of the test plan that contains the suites.
        :param int suite_id: ID of the parent suite.
        :rtype: :class:`<TestSuite> <azure.devops.v6_0.test_plan.models.TestSuite>`
    ...
    def get_test_case_list(self, project, plan_id, suite_id, test_ids=None, configuration_ids=None, wit_fields=None, continuation_token=None, return_identity_ref=None, expand=None, exclude_flags=None):
        ...
        :param str exclude_flags: Flag to exclude various values from payload. For example to remove point assignments pass exclude = 1. To remove extra information (links, test plan , test suite) pass exclude = 2. To remove both extra information and point assignments pass exclude = 3 (1 + 2).
        :rtype: :class:`<[TestCase]> <azure.devops.v6_0.test_plan.models.[TestCase]>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def clone_test_plan(self, clone_request_body, project, deep_clone=None):
        ...
        :param :class:`<CloneTestPlanParams> <azure.devops.v6_0.test_plan.models.CloneTestPlanParams>` clone_request_body: Plan Clone Request Body detail TestPlanCloneRequest
        :param str project: Project ID or project name
        :param bool deep_clone: Clones all the associated test cases as well
        :rtype: :class:`<CloneTestPlanOperationInformation> <azure.devops.v6_0.test_plan.models.CloneTestPlanOperationInformation>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def clone_test_suite(self, clone_request_body, project, deep_clone=None):
        ...
        :param :class:`<CloneTestSuiteParams> <azure.devops.v6_0.test_plan.models.CloneTestSuiteParams>` clone_request_body: Suite Clone Request Body detail TestSuiteCloneRequest
        :param str project: Project ID or project name
        :param bool deep_clone: Clones all the associated test cases as well
        :rtype: :class:`<CloneTestSuiteOperationInformation> <azure.devops.v6_0.test_plan.models.CloneTestSuiteOperationInformation>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def create_test_variable(self, test_variable_create_update_parameters, project):
        ...
        :param :class:`<TestVariableCreateUpdateParameters> <azure.devops.v6_0.test_plan.models.TestVariableCreateUpdateParameters>` test_variable_create_update_parameters: TestVariableCreateUpdateParameters
        :param str project: Project ID or project name
        :rtype: :class:`<TestVariable> <azure.devops.v6_0.test_plan.models.TestVariable>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
