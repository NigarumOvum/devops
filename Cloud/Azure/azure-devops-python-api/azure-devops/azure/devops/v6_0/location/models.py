...
class ConnectionData(Model):
    ...
    :type authenticated_user: :class:`Identity <azure.devops.v6_0.locations.models.Identity>`
    ...
    :type authorized_user: :class:`Identity <azure.devops.v6_0.locations.models.Identity>`
    ...
    :type location_service_data: :class:`LocationServiceData <azure.devops.v6_0.locations.models.LocationServiceData>`
...
class LocationServiceData(Model):
    ...
    :type access_mappings: list of :class:`AccessMapping <azure.devops.v6_0.locations.models.AccessMapping>`
    ...
    :type service_definitions: list of :class:`ServiceDefinition <azure.devops.v6_0.locations.models.ServiceDefinition>`
...
class ServiceDefinition(Model):
    ...
    :type location_mappings: list of :class:`LocationMapping <azure.devops.v6_0.locations.models.LocationMapping>`
    ...
    :param properties:
    :type properties: :class:`object <azure.devops.v6_0.locations.models.object>`
    :param relative_path:
