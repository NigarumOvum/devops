...
class WorkItemTrackingProcessTemplateClient(Client):
    ...
    def get_behavior(self, process_id, behavior_ref_name):
        ...
        :rtype: :class:`<AdminBehavior> <azure.devops.v6_0.work_item_tracking_process_template.models.AdminBehavior>`
        """
        route_values = {}
    ...
    def import_process_template(self, upload_stream, ignore_warnings=None, replace_existing_template=None, **kwargs):
        ...
        :rtype: :class:`<ProcessImportResult> <azure.devops.v6_0.work_item_tracking_process_template.models.ProcessImportResult>`
        """
        route_values = {}
    ...
    def import_process_template_status(self, id):
        ...
        :rtype: :class:`<ProcessPromoteStatus> <azure.devops.v6_0.work_item_tracking_process_template.models.ProcessPromoteStatus>`
        """
        route_values = {}
        if id is not None:
            route_values['id'] = self._serialize.url('id', id, 'str')
