...
class ArtifactMetadata(Model):
    ...
    :type instance_reference: :class:`BuildVersion <azure.devops.v6_0.release.models.BuildVersion>`
    """
...
class ArtifactTypeDefinition(Model):
    ...
    :type artifact_trigger_configuration: :class:`ArtifactTriggerConfiguration <azure.devops.v6_0.release.models.ArtifactTriggerConfiguration>`
    ...
    :type input_descriptors: list of :class:`InputDescriptor <azure.devops.v6_0.release.models.InputDescriptor>`
...
class Release(Model):
    ...
    :type artifacts: list of :class:`Artifact <azure.devops.v6_0.release.models.Artifact>`
    ...
    :type created_for: :class:`IdentityRef <azure.devops.v6_0.release.models.IdentityRef>`
    :param created_on: Gets date on which it got created.
    :type created_on: datetime
    ...
    :type environments: list of :class:`ReleaseEnvironment <azure.devops.v6_0.release.models.ReleaseEnvironment>`
    :param id: Gets the unique identifier of this field.
    :type id: int
    ...
    :type modified_by: :class:`IdentityRef <azure.devops.v6_0.release.models.IdentityRef>`
    :param modified_on: Gets date on which it got modified.
    :type modified_on: datetime
    ...
    :type project_reference: :class:`ProjectReference <azure.devops.v6_0.release.models.ProjectReference>`
    :param properties:
    :type properties: :class:`object <azure.devops.v6_0.release.models.object>`
    ...
    :type variable_groups: list of :class:`VariableGroup <azure.devops.v6_0.release.models.VariableGroup>`
...
class ReleaseApproval(Model):
    ...
    :type approved_by: :class:`IdentityRef <azure.devops.v6_0.release.models.IdentityRef>`
    :param approver: Gets or sets the identity who should approve.
    :type approver: :class:`IdentityRef <azure.devops.v6_0.release.models.IdentityRef>`
    ...
    :type history: list of :class:`ReleaseApprovalHistory <azure.devops.v6_0.release.models.ReleaseApprovalHistory>`
    :param id: Gets the unique identifier of this field.
    :type id: int
...
class ReleaseApprovalHistory(Model):
    ...
    :type changed_by: :class:`IdentityRef <azure.devops.v6_0.release.models.IdentityRef>`
...
class ReleaseDefinitionApprovals(Model):
    ...
    :type approval_options: :class:`ApprovalOptions <azure.devops.v6_0.release.models.ApprovalOptions>`
    :param approvals: Gets or sets the approvals.
    :type approvals: list of :class:`ReleaseDefinitionApprovalStep <azure.devops.v6_0.release.models.ReleaseDefinitionApprovalStep>`
    """
...
class ReleaseDefinitionEnvironment(Model):
    ...
    :type current_release: :class:`ReleaseShallowReference <azure.devops.v6_0.release.models.ReleaseShallowReference>`
    :param demands: Gets or sets the demands.
    :type demands: list of :class:`object <azure.devops.v6_0.release.models.object>`
    :param deploy_phases: Gets or sets the deploy phases of environment.
    :type deploy_phases: list of :class:`object <azure.devops.v6_0.release.models.object>`
    :param deploy_step: Gets or sets the deploystep.
    :type deploy_step: :class:`ReleaseDefinitionDeployStep <azure.devops.v6_0.release.models.ReleaseDefinitionDeployStep>`
    :param environment_options: Gets or sets the environment options.
    :type environment_options: :class:`EnvironmentOptions <azure.devops.v6_0.release.models.EnvironmentOptions>`
    :param environment_triggers: Gets or sets the triggers on environment.
    :type environment_triggers: list of :class:`EnvironmentTrigger <azure.devops.v6_0.release.models.EnvironmentTrigger>`
    :param execution_policy: Gets or sets the environment execution policy.
    :type execution_policy: :class:`EnvironmentExecutionPolicy <azure.devops.v6_0.release.models.EnvironmentExecutionPolicy>`
    ...
    :type owner: :class:`IdentityRef <azure.devops.v6_0.release.models.IdentityRef>`
    :param post_deploy_approvals: Gets or sets the post deployment approvals.
    :type post_deploy_approvals: :class:`ReleaseDefinitionApprovals <azure.devops.v6_0.release.models.ReleaseDefinitionApprovals>`
    :param post_deployment_gates: Gets or sets the post deployment gates.
    :type post_deployment_gates: :class:`ReleaseDefinitionGatesStep <azure.devops.v6_0.release.models.ReleaseDefinitionGatesStep>`
    :param pre_deploy_approvals: Gets or sets the pre deployment approvals.
    :type pre_deploy_approvals: :class:`ReleaseDefinitionApprovals <azure.devops.v6_0.release.models.ReleaseDefinitionApprovals>`
    :param pre_deployment_gates: Gets or sets the pre deployment gates.
    :type pre_deployment_gates: :class:`ReleaseDefinitionGatesStep <azure.devops.v6_0.release.models.ReleaseDefinitionGatesStep>`
    :param process_parameters: Gets or sets the environment process parameters.
    :type process_parameters: :class:`ProcessParameters <azure.devops.v6_0.release.models.ProcessParameters>`
    ...
    :type retention_policy: :class:`EnvironmentRetentionPolicy <azure.devops.v6_0.release.models.EnvironmentRetentionPolicy>`
    :param run_options:
    :type run_options: dict
    :param schedules: Gets or sets the schedules
    :type schedules: list of :class:`ReleaseSchedule <azure.devops.v6_0.release.models.ReleaseSchedule>`
...
class ReleaseDefinitionEnvironmentSummary(Model):
    ...
    :type last_releases: list of :class:`ReleaseShallowReference <azure.devops.v6_0.release.models.ReleaseShallowReference>`
...
class ReleaseDefinitionEnvironmentTemplate(Model):
    ...
    :type environment: :class:`ReleaseDefinitionEnvironment <azure.devops.v6_0.release.models.ReleaseDefinitionEnvironment>`
...
class ReleaseDefinitionGate(Model):
    ...
    :type tasks: list of :class:`WorkflowTask <azure.devops.v6_0.release.models.WorkflowTask>`
    """
...
class ReleaseDefinitionGatesStep(Model):
    ...
    :type gates: list of :class:`ReleaseDefinitionGate <azure.devops.v6_0.release.models.ReleaseDefinitionGate>`
    :param gates_options: Gets or sets the gate options.
    :type gates_options: :class:`ReleaseDefinitionGatesOptions <azure.devops.v6_0.release.models.ReleaseDefinitionGatesOptions>`
...
class ReleaseDefinitionSummary(Model):
    ...
    :type environments: list of :class:`ReleaseDefinitionEnvironmentSummary <azure.devops.v6_0.release.models.ReleaseDefinitionEnvironmentSummary>`
    ...
    :type releases: list of :class:`Release <azure.devops.v6_0.release.models.Release>`
    """
...
class ReleaseDeployPhase(Model):
    ...
    :type deployment_jobs: list of :class:`DeploymentJob <azure.devops.v6_0.release.models.DeploymentJob>`
    ...
    :type manual_interventions: list of :class:`ManualIntervention <azure.devops.v6_0.release.models.ManualIntervention>`
...
class ReleaseEnvironment(Model):
    ...
    :type conditions: list of :class:`ReleaseCondition <azure.devops.v6_0.release.models.ReleaseCondition>`
    :param created_on: Gets date on which it got created.
    :type created_on: datetime
    ...
    :type deploy_phases_snapshot: list of :class:`object <azure.devops.v6_0.release.models.object>`
    :param deploy_steps: Gets deploy steps.
    :type deploy_steps: list of :class:`DeploymentAttempt <azure.devops.v6_0.release.models.DeploymentAttempt>`
    ...
    :type post_approvals_snapshot: :class:`ReleaseDefinitionApprovals <azure.devops.v6_0.release.models.ReleaseDefinitionApprovals>`
    ...
    :type post_deployment_gates_snapshot: :class:`ReleaseDefinitionGatesStep <azure.devops.v6_0.release.models.ReleaseDefinitionGatesStep>`
    :param pre_approvals_snapshot: Gets list of pre deploy approvals snapshot.
    :type pre_approvals_snapshot: :class:`ReleaseDefinitionApprovals <azure.devops.v6_0.release.models.ReleaseDefinitionApprovals>`
    ...
    :type pre_deployment_gates_snapshot: :class:`ReleaseDefinitionGatesStep <azure.devops.v6_0.release.models.ReleaseDefinitionGatesStep>`
    ...
    :type release_created_by: :class:`IdentityRef <azure.devops.v6_0.release.models.IdentityRef>`
    ...
    :type workflow_tasks: list of :class:`WorkflowTask <azure.devops.v6_0.release.models.WorkflowTask>`
    """
...
class ReleaseGates(Model):
    ...
    :type ignored_gates: list of :class:`IgnoredGate <azure.devops.v6_0.release.models.IgnoredGate>`
...
class ReleaseSettings(Model):
    ...
    :type compliance_settings: :class:`ComplianceSettings <azure.devops.v6_0.release.models.ComplianceSettings>`
    :param retention_settings: Release retention settings.
    :type retention_settings: :class:`RetentionSettings <azure.devops.v6_0.release.models.RetentionSettings>`
    """
...
class ReleaseStartMetadata(Model):
    ...
    :type artifacts: list of :class:`ArtifactMetadata <azure.devops.v6_0.release.models.ArtifactMetadata>`
    ...
    :type environments_metadata: list of :class:`ReleaseStartEnvironmentMetadata <azure.devops.v6_0.release.models.ReleaseStartEnvironmentMetadata>`
...
class ReleaseTask(Model):
    ...
    :type task: :class:`WorkflowTaskReference <azure.devops.v6_0.release.models.WorkflowTaskReference>`
...
class RetentionSettings(Model):
    ...
    :type default_environment_retention_policy: :class:`EnvironmentRetentionPolicy <azure.devops.v6_0.release.models.EnvironmentRetentionPolicy>`
    :param maximum_environment_retention_policy: Specifies the maximum environment retention policy.
    :type maximum_environment_retention_policy: :class:`EnvironmentRetentionPolicy <azure.devops.v6_0.release.models.EnvironmentRetentionPolicy>`
    """
...
class VariableGroup(Model):
    ...
    :type provider_data: :class:`VariableGroupProviderData <azure.devops.v6_0.release.models.VariableGroupProviderData>`
    ...
    :type variable_group_project_references: list of :class:`VariableGroupProjectReference <azure.devops.v6_0.release.models.VariableGroupProjectReference>`
...
class ReleaseDefinition(ReleaseDefinitionShallowReference):
    ...
    :type environments: list of :class:`ReleaseDefinitionEnvironment <azure.devops.v6_0.release.models.ReleaseDefinitionEnvironment>`
    :param is_deleted: Whether release definition is deleted.
    :type is_deleted: bool
    :param last_release: Gets the reference of last release.
    :type last_release: :class:`ReleaseReference <azure.devops.v6_0.release.models.ReleaseReference>`
    :param modified_by: Gets or sets the identity who modified.
    :type modified_by: :class:`IdentityRef <azure.devops.v6_0.release.models.IdentityRef>`
    :param modified_on: Gets date on which it got modified.
    :type modified_on: datetime
    :param pipeline_process: Gets or sets pipeline process.
    :type pipeline_process: :class:`PipelineProcess <azure.devops.v6_0.release.models.PipelineProcess>`
    :param properties: Gets or sets properties.
    :type properties: :class:`object <azure.devops.v6_0.release.models.object>`
    :param release_name_format: Gets or sets the release name format.
    :type release_name_format: str
    :param retention_policy:
    :type retention_policy: :class:`RetentionPolicy <azure.devops.v6_0.release.models.RetentionPolicy>`
    :param revision: Gets the revision number.
    :type revision: int
    ...
    :type triggers: list of :class:`object <azure.devops.v6_0.release.models.object>`
