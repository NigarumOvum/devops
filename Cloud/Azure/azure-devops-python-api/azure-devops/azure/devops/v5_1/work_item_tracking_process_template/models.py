...
class AdminBehavior(Model):
    ...
    :type fields: list of :class:`AdminBehaviorField <azure.devops.v5_1.work_item_tracking_process_template.models.AdminBehaviorField>`
...
class ProcessImportResult(Model):
    ...
    :type validation_results: list of :class:`ValidationIssue <azure.devops.v5_1.work_item_tracking_process_template.models.ValidationIssue>`
    """
