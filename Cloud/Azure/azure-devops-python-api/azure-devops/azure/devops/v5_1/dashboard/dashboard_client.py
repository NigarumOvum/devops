...
class DashboardClient(Client):
    ...
    def update_widget(self, widget, team_context, dashboard_id, widget_id):
        ...
        :param :class:`<Widget> <azure.devops.v5_1.dashboard.models.Widget>` widget: Description of the widget changes to apply. All non-null fields will be replaced.
        :param :class:`<TeamContext> <azure.devops.v5_1.dashboard.models.TeamContext>` team_context: The team context for the operation
        :param str dashboard_id: ID of the dashboard containing the widget.
        :param str widget_id: ID of the widget to update.
        :rtype: :class:`<Widget> <azure.devops.v5_1.dashboard.models.Widget>`
    ...
    def get_widget_metadata(self, contribution_id, project=None):
        ...
        :rtype: :class:`<WidgetMetadataResponse> <azure.devops.v5_1.dashboard.models.WidgetMetadataResponse>`
        """
        route_values = {}
        if project is not None:
    ...
    def get_widget_types(self, scope, project=None):
        ...
        :param str scope:
        :param str project: Project ID or project name
        :rtype: :class:`<WidgetTypesResponse> <azure.devops.v5_1.dashboard.models.WidgetTypesResponse>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
