...
class AggregatedDataForResultTrend(Model):
    ...
    :type test_results_context: :class:`TestResultsContext <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.TestResultsContext>`
    :param total_tests:
...
class BuildCoverage(Model):
    ...
    :type configuration: :class:`BuildConfiguration <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.BuildConfiguration>`
    :param last_error: Last Error
    :type last_error: str
    :param modules: List of Modules
    :type modules: list of :class:`ModuleCoverage <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.ModuleCoverage>`
    :param state: State
    :type state: str
    """
...
class CodeCoverageData(Model):
    ...
    :type coverage_stats: list of :class:`CodeCoverageStatistics <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.CodeCoverageStatistics>`
    """
...
class CodeCoverageSummary(Model):
    ...
    :type coverage_data: list of :class:`CodeCoverageData <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.CodeCoverageData>`
    :param delta_build: Uri of build against which difference in coverage is computed
    :type delta_build: :class:`ShallowReference <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
...
class FlakySettings(Model):
    ...
    def __init__(self, flaky_detection=None, flaky_in_summary_report=None, manual_mark_unmark_flaky=None):
...
class FunctionCoverage(Model):
    ...
    :param statistics:
    :type statistics: :class:`CoverageStatistics <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.CoverageStatistics>`
    """
...
class ModuleCoverage(Model):
    ...
    :type file_url: str
    :param functions:
    :type functions: list of :class:`FunctionCoverage <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.FunctionCoverage>`
    :param name:
    :type name: str
    :param signature:
    :type signature: str
...
class RunCreateModel(Model):
    ...
    :type build_reference: :class:`BuildConfiguration <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.BuildConfiguration>`
    ...
    :type custom_test_fields: list of :class:`CustomTestField <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.CustomTestField>`
    :param dtl_aut_environment: An abstracted reference to DtlAutEnvironment.
    :type dtl_aut_environment: :class:`ShallowReference <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    :param dtl_test_environment: An abstracted reference to DtlTestEnvironment.
    :type dtl_test_environment: :class:`ShallowReference <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    :param due_date: Due date and time for test run.
    :type due_date: str
    :param environment_details:
    :type environment_details: :class:`DtlEnvironmentDetails <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.DtlEnvironmentDetails>`
    :param error_message: Error message associated with the run.
    :type error_message: str
    :param filter: Filter used for discovering the Run.
    :type filter: :class:`RunFilter <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.RunFilter>`
    ...
    :type plan: :class:`ShallowReference <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    ...
    :type release_reference: :class:`ReleaseReference <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.ReleaseReference>`
    ...
    :type test_settings: :class:`ShallowReference <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
...
class RunStatistic(Model):
    ...
    :type resolution_state: :class:`TestResolutionState <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.TestResolutionState>`
...
class RunUpdateModel(Model):
    ...
    :type dtl_environment: :class:`ShallowReference <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    :param dtl_environment_details:
    :type dtl_environment_details: :class:`DtlEnvironmentDetails <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.DtlEnvironmentDetails>`
    :param due_date: Due date and time for test run.
    :type due_date: str
    :param error_message: Error message associated with the run.
    :type error_message: str
    ...
    :type log_entries: list of :class:`TestMessageLogDetails <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.TestMessageLogDetails>`
    :param name: Name of the test run.
    :type name: str
    :param release_environment_uri: URI of release environment associated with the run.
    :type release_environment_uri: str
...
class TestCaseResult(Model):
    ...
    :type area: :class:`ShallowReference <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    :param associated_bugs: Reference to bugs linked to test result.
    :type associated_bugs: list of :class:`ShallowReference <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    ...
    :type build_reference: :class:`BuildReference <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.BuildReference>`
    ...
    :type configuration: :class:`ShallowReference <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    :param created_date: Timestamp when test result created.
    :type created_date: datetime
    :param custom_fields: Additional properties of test result.
    :type custom_fields: list of :class:`CustomTestField <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.CustomTestField>`
    ...
    :type failing_since: :class:`FailingSince <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.FailingSince>`
    ...
    :type release: :class:`ShallowReference <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    ...
    :type sub_results: list of :class:`TestSubResult <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.TestSubResult>`
    :param test_case: Reference to the test executed.
    :type test_case: :class:`ShallowReference <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    ...
    :type test_plan: :class:`ShallowReference <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    :param test_point: Reference to the test point executed.
    :type test_point: :class:`ShallowReference <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    :param test_run: Reference to test run.
    :type test_run: :class:`ShallowReference <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    :param test_suite: Reference to test suite test case workitem is part of.
    :type test_suite: :class:`ShallowReference <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
...
class TestFailureDetails(Model):
    ...
    :type count: int
    :param test_results:
    :type test_results: list of :class:`TestCaseResultIdentifier <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.TestCaseResultIdentifier>`
    """
...
class TestFailuresAnalysis(Model):
    ...
    :param fixed_tests:
    :type fixed_tests: :class:`TestFailureDetails <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.TestFailureDetails>`
    :param new_failures:
    :type new_failures: :class:`TestFailureDetails <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.TestFailureDetails>`
    :param previous_context:
    :type previous_context: :class:`TestResultsContext <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.TestResultsContext>`
    """
...
class TestHistoryQuery(Model):
    ...
    :type results_for_group: list of :class:`TestResultHistoryForGroup <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.TestResultHistoryForGroup>`
...
class TestIterationDetailsModel(Model):
    ...
    :type parameters: list of :class:`TestResultParameterModel <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.TestResultParameterModel>`
...
class TestLogReference(Model):
    ...
    :type run_id: int
    :param scope: Test Log Reference object
    :type scope: object
...
class TestResultDocument(Model):
    ...
    :param payload:
    :type payload: :class:`TestResultPayload <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.TestResultPayload>`
    """
...
class TestResultHistory(Model):
    ...
    :type results_for_group: list of :class:`TestResultHistoryDetailsForGroup <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.TestResultHistoryDetailsForGroup>`
    """
...
class TestResultHistoryDetailsForGroup(Model):
    ...
    :type group_by_value: object
    :param latest_result:
    :type latest_result: :class:`TestCaseResult <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.TestCaseResult>`
    """
...
class TestResultHistoryForGroup(Model):
    ...
    :type results: list of :class:`TestCaseResult <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.TestCaseResult>`
    """
...
class TestResultsDetails(Model):
    ...
    :type group_by_field: str
    :param results_for_group:
    :type results_for_group: list of :class:`TestResultsDetailsForGroup <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.TestResultsDetailsForGroup>`
    """
...
class TestResultsQuery(Model):
    ...
    :type results_filter: :class:`ResultsFilter <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.ResultsFilter>`
    """
...
class TestRun(Model):
    ...
    :type build_configuration: :class:`BuildConfiguration <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.BuildConfiguration>`
    :param comment: Comments entered by those analyzing the run.
    :type comment: str
    :param completed_date: Completed date time of the run.
    :type completed_date: datetime
    ...
    :type dtl_environment_creation_details: :class:`DtlEnvironmentDetails <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.DtlEnvironmentDetails>`
    :param due_date: Due date and time for test run.
    ...
    :type run_statistics: list of :class:`RunStatistic <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.RunStatistic>`
    :param started_date: Start date time of the run.
    :type started_date: datetime
    :param state: The state of the run. Type TestRunState Valid states - Unspecified ,NotStarted, InProgress, Completed, Waiting, Aborted, NeedsInvestigation
    :type state: str
    ...
    :type test_environment: :class:`TestEnvironment <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.TestEnvironment>`
...
class TestSubResult(Model):
    ...
    :type test_result: :class:`TestCaseResultIdentifier <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.TestCaseResultIdentifier>`
...
class TestSummaryForWorkItem(Model):
    ...
    :param work_item:
    :type work_item: :class:`WorkItemReference <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.WorkItemReference>`
    """
...
class TestToWorkItemLinks(Model):
    ...
    :param work_items:
    :type work_items: list of :class:`WorkItemReference <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.WorkItemReference>`
    """
...
class WorkItemToTestLinks(Model):
    ...
    :type executed_in: object
    :param tests:
    :type tests: list of :class:`TestMethod <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.TestMethod>`
    :param work_item:
    :type work_item: :class:`WorkItemReference <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.WorkItemReference>`
    """
...
class TestActionResultModel(TestResultModelBase):
    ...
    :type shared_step_model: :class:`SharedStepModel <azure.devops.v5_1.microsoft._team_foundation._test_management._web_api.models.SharedStepModel>`
    :param step_identifier: This is step Id of test case. For shared step, it is step Id of shared step in test case workitem; step Id in shared step. Example: TestCase workitem has two steps: 1) Normal step with Id = 1 2) Shared Step with Id = 2. Inside shared step: a) Normal Step with Id = 1 Value for StepIdentifier for First step: "1" Second step: "2;1"
    :type step_identifier: str
